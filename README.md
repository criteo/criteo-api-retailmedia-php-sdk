...
either run the following command: `composer require criteo/criteo-api-retailmedia-sdk:2023.04.0.240626`
...
------------ | ------------- | ------------- | -------------
*AnalyticsApi* | [**generateAsyncCampaignsReport**](docs/Api/AnalyticsApi.md#generateasynccampaignsreport) | **POST** /2023-04/retail-media/reports/campaigns | 
*AnalyticsApi* | [**generateAsyncLineItemsReport**](docs/Api/AnalyticsApi.md#generateasynclineitemsreport) | **POST** /2023-04/retail-media/reports/line-items | 
*AnalyticsApi* | [**getAsyncExportOutput**](docs/Api/AnalyticsApi.md#getasyncexportoutput) | **GET** /2023-04/retail-media/reports/{reportId}/output | 
*AnalyticsApi* | [**getAsyncExportStatus**](docs/Api/AnalyticsApi.md#getasyncexportstatus) | **GET** /2023-04/retail-media/reports/{reportId}/status | 
*AudienceApi* | [**legacyCreateAudienceV1**](docs/Api/AudienceApi.md#legacycreateaudiencev1) | **POST** /2023-04/retail-media/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyGetAudienceV1**](docs/Api/AudienceApi.md#legacygetaudiencev1) | **GET** /2023-04/retail-media/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyGetAudienceV2**](docs/Api/AudienceApi.md#legacygetaudiencev2) | **GET** /2023-04/retail-media/v2/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyUpdateAudienceV2**](docs/Api/AudienceApi.md#legacyupdateaudiencev2) | **POST** /2023-04/retail-media/v2/accounts/{accountId}/audiences | 
...
*CampaignApi* | [**getApi202301ExternalAccountCampaignsByAccountId**](docs/Api/CampaignApi.md#getapi202301externalaccountcampaignsbyaccountid) | **GET** /2023-04/retail-media/accounts/{account-id}/campaigns | 
...
*CampaignApi* | [**postApi202301ExternalAccountCampaignsByAccountId**](docs/Api/CampaignApi.md#postapi202301externalaccountcampaignsbyaccountid) | **POST** /2023-04/retail-media/accounts/{account-id}/campaigns | 
