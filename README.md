...
either run the following command: `composer require criteo/criteo-api-retailmedia-sdk:2023.01.0.240207`
...
------------ | ------------- | ------------- | -------------
*AnalyticsApi* | [**generateAsyncCampaignsReport**](docs/Api/AnalyticsApi.md#generateasynccampaignsreport) | **POST** /2023-01/retail-media/reports/campaigns | 
*AnalyticsApi* | [**generateAsyncLineItemsReport**](docs/Api/AnalyticsApi.md#generateasynclineitemsreport) | **POST** /2023-01/retail-media/reports/line-items | 
*AnalyticsApi* | [**getAsyncExportOutput**](docs/Api/AnalyticsApi.md#getasyncexportoutput) | **GET** /2023-01/retail-media/reports/{reportId}/output | 
*AnalyticsApi* | [**getAsyncExportStatus**](docs/Api/AnalyticsApi.md#getasyncexportstatus) | **GET** /2023-01/retail-media/reports/{reportId}/status | 
*AudienceApi* | [**legacyCreateAudienceV1**](docs/Api/AudienceApi.md#legacycreateaudiencev1) | **POST** /2023-01/retail-media/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyGetAudienceV1**](docs/Api/AudienceApi.md#legacygetaudiencev1) | **GET** /2023-01/retail-media/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyGetAudienceV2**](docs/Api/AudienceApi.md#legacygetaudiencev2) | **GET** /2023-01/retail-media/v2/accounts/{accountId}/audiences | 
*AudienceApi* | [**legacyUpdateAudienceV2**](docs/Api/AudienceApi.md#legacyupdateaudiencev2) | **POST** /2023-01/retail-media/v2/accounts/{accountId}/audiences | 
*CampaignApi* | [**createAsset**](docs/Api/CampaignApi.md#createasset) | **POST** /2023-01/retail-media/assets | 
*CampaignApi* | [**getApi202110ExternalAccountBalancesByAccountId**](docs/Api/CampaignApi.md#getapi202110externalaccountbalancesbyaccountid) | **GET** /2023-01/retail-media/accounts/{account-id}/balances | 
...
*CampaignApi* | [**getApi202301ExternalAccountCampaignsByAccountId**](docs/Api/CampaignApi.md#getapi202301externalaccountcampaignsbyaccountid) | **GET** /2023-01/retail-media/accounts/{account-id}/campaigns | 
...
*CampaignApi* | [**getApiV2ExternalAccountLineItemsByAccountId**](docs/Api/CampaignApi.md#getapiv2externalaccountlineitemsbyaccountid) | **GET** /2023-01/retail-media/accounts/{account-id}/line-items | 
...
*CampaignApi* | [**postApi202301ExternalAccountCampaignsByAccountId**](docs/Api/CampaignApi.md#postapi202301externalaccountcampaignsbyaccountid) | **POST** /2023-01/retail-media/accounts/{account-id}/campaigns | 
*CampaignApi* | [**postApiV1ExternalAccountCatalogsByAccountId**](docs/Api/CampaignApi.md#postapiv1externalaccountcatalogsbyaccountid) | **POST** /2023-01/retail-media/accounts/{accountId}/catalogs | 
...
*GatewayApi* | [**getCurrentApplication**](docs/Api/GatewayApi.md#getcurrentapplication) | **GET** /2023-01/retail-media/me | 
