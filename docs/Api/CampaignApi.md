...
| **value_resource_input_of_brand_catalog_request_v2** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputOfBrandCatalogRequestV2**](../Model/ValueResourceInputOfBrandCatalogRequestV2.md)|  | |
...
| **post_campaign_v202301** | [**\criteo\api\retailmedia\v2025_10\Model\PostCampaignV202301**](../Model/PostCampaignV202301.md)| The campaign settings to create a campaign with | |
...
| **creative_create_model202207** | [**\criteo\api\retailmedia\v2025_10\Model\CreativeCreateModel202207**](../Model/CreativeCreateModel202207.md)| The creative to create | |
...
| **preferred_line_item_create_model_v2_request** | [**\criteo\api\retailmedia\v2025_10\Model\PreferredLineItemCreateModelV2Request**](../Model/PreferredLineItemCreateModelV2Request.md)| The line item settings to create a line item with | |
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **value_resource_input_of_seller_catalog_request_v2** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputOfSellerCatalogRequestV2**](../Model/ValueResourceInputOfSellerCatalogRequestV2.md)|  | |
...
[**\criteo\api\retailmedia\v2025_10\Model\RetailerPages202110**](../Model/RetailerPages202110.md)
...
| **value_resource_input_cpc_min_bids_request** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputCpcMinBidsRequest**](../Model/ValueResourceInputCpcMinBidsRequest.md)| Cpc minimum bid amount request object. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **retailer_id** | **string**| Retailer id. | |
| **value_resource_input_recommended_categories_request_v1** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputRecommendedCategoriesRequestV1**](../Model/ValueResourceInputRecommendedCategoriesRequestV1.md)| Request of recommended categories. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| The given campaign id | |
| **auction_line_item_create_model_request** | [**\criteo\api\retailmedia\v2025_10\Model\AuctionLineItemCreateModelRequest**](../Model/AuctionLineItemCreateModelRequest.md)| The line item settings to create a line item with | |
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **json_api_request_of_seller_catalog_request** | [**\criteo\api\retailmedia\v2025_10\Model\JsonApiRequestOfSellerCatalogRequest**](../Model/JsonApiRequestOfSellerCatalogRequest.md)|  | |
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **json_api_request_of_catalog_request** | [**\criteo\api\retailmedia\v2025_10\Model\JsonApiRequestOfCatalogRequest**](../Model/JsonApiRequestOfCatalogRequest.md)|  | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **add_to_basket_target202110_request** | [**\criteo\api\retailmedia\v2025_10\Model\AddToBasketTarget202110Request**](../Model/AddToBasketTarget202110Request.md)| The add to basket target to set the scope for | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **audience_target202110_request** | [**\criteo\api\retailmedia\v2025_10\Model\AudienceTarget202110Request**](../Model/AudienceTarget202110Request.md)| The audience target to set the scope for | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **store_target202110_request** | [**\criteo\api\retailmedia\v2025_10\Model\StoreTarget202110Request**](../Model/StoreTarget202110Request.md)| The store target to set the scope for | |
...
| ------------- | ------------- | ------------- | ------------- |
| **retailer_id** | **string**| Retailer id. | |
| **value_resource_input_recommended_keywords_request_v1** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputRecommendedKeywordsRequestV1**](../Model/ValueResourceInputRecommendedKeywordsRequestV1.md)| Request of recommended keywords. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The given line item id | |
| **auction_line_item_update_model_request** | [**\criteo\api\retailmedia\v2025_10\Model\AuctionLineItemUpdateModelRequest**](../Model/AuctionLineItemUpdateModelRequest.md)| The line item settings to create a line item with | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| LineItemId for bid multiplier retrieval | |
| **line_item_bid_multipliers_v2_request** | [**\criteo\api\retailmedia\v2025_10\Model\LineItemBidMultipliersV2Request**](../Model/LineItemBidMultipliersV2Request.md)| New Bid Multipliers to be set | |
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| Campaign id. | |
| **value_resource_input_of_campaign_budget_overrides** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputOfCampaignBudgetOverrides**](../Model/ValueResourceInputOfCampaignBudgetOverrides.md)| New campaign budget overrides settings value resource input. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| The given campaign id | |
| **put_campaign_v202301** | [**\criteo\api\retailmedia\v2025_10\Model\PutCampaignV202301**](../Model/PutCampaignV202301.md)| The campaign settings to update that campaign with | |
...
| **creative_update_model202207** | [**\criteo\api\retailmedia\v2025_10\Model\CreativeUpdateModel202207**](../Model/CreativeUpdateModel202207.md)| The creative to create | |
...
| **value_resource_input_of_line_item_budget_overrides** | [**\criteo\api\retailmedia\v2025_10\Model\ValueResourceInputOfLineItemBudgetOverrides**](../Model/ValueResourceInputOfLineItemBudgetOverrides.md)| New line item budget overrides settings value resource input. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The given line item id | |
| **preferred_line_item_update_model_v2_request** | [**\criteo\api\retailmedia\v2025_10\Model\PreferredLineItemUpdateModelV2Request**](../Model/PreferredLineItemUpdateModelV2Request.md)| The line item settings to create a line item with | |
