...
```php
addRemoveKeywords($id, $add_remove_keywords_model_request): \criteo\api\retailmedia\v2023_04\Model\ResourceOutcome
```
...
$add_remove_keywords_model_request = new \criteo\api\retailmedia\v2023_04\Model\AddRemoveKeywordsModelRequest(); // \criteo\api\retailmedia\v2023_04\Model\AddRemoveKeywordsModelRequest
...
| **add_remove_keywords_model_request** | [**\criteo\api\retailmedia\v2023_04\Model\AddRemoveKeywordsModelRequest**](../Model/AddRemoveKeywordsModelRequest.md)|  | [optional] |

### Return type

[**\criteo\api\retailmedia\v2023_04\Model\ResourceOutcome**](../Model/ResourceOutcome.md)
...
```php
fetchKeywords($id): \criteo\api\retailmedia\v2023_04\Model\KeywordsModelResponse
```
...
[**\criteo\api\retailmedia\v2023_04\Model\KeywordsModelResponse**](../Model/KeywordsModelResponse.md)
...
```php
fetchProposal($id): \criteo\api\retailmedia\v2023_04\Model\ProposalStatusModelResponse
```
...
[**\criteo\api\retailmedia\v2023_04\Model\ProposalStatusModelResponse**](../Model/ProposalStatusModelResponse.md)
...
```php
setKeywordBids($id, $set_bids_model_request): \criteo\api\retailmedia\v2023_04\Model\ResourceOutcome
```
...
$id = 'id_example'; // string | ID of the line item
$set_bids_model_request = new \criteo\api\retailmedia\v2023_04\Model\SetBidsModelRequest(); // \criteo\api\retailmedia\v2023_04\Model\SetBidsModelRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| ID of the line item | |
| **set_bids_model_request** | [**\criteo\api\retailmedia\v2023_04\Model\SetBidsModelRequest**](../Model/SetBidsModelRequest.md)|  | [optional] |
...
```php
submitProposal($id): \criteo\api\retailmedia\v2023_04\Model\ProposalStatusModelResponse
```
