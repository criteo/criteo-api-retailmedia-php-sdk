...
```php
appendPromotedProducts($line_item_id, $promoted_product_resource_collection_input): \criteo\api\retailmedia\v2025_01\Model\ProductResourceOutcome
```
...
[**\criteo\api\retailmedia\v2025_01\Model\ProductResourceOutcome**](../Model/ProductResourceOutcome.md)
...
```php
fetchPromotedProducts($line_item_id, $fields, $limit, $offset): \criteo\api\retailmedia\v2025_01\Model\PromotedProductResourceCollectionOutcome
```
...
```php
getApi202204ExternalCategories($page_index, $page_size, $retailer_id, $text_substring): \criteo\api\retailmedia\v2025_01\Model\Category202204ListResponse
```
...
```php
getApiV2ExternalAccountLineItemsByAccountId($account_id, $limit_to_campaign_id, $limit_to_id, $limit_to_type, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\CommonLineItemPagedListResponse
```
