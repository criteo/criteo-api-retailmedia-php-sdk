...
```php
appendAddToBasketTargetsByLineItemId($line_item_id, $add_to_basket_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\AddToBasketTarget202110Response
```
...
```php
appendAudienceTargetsByLineItemId($line_item_id, $audience_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\AudienceTarget202110Response
```
...
```php
appendCampaignsByBalanceId($balance_id, $balance_campaign202110_list_request): \criteo\api\retailmedia\v2025_01\Model\BalanceCampaign202110PagedListResponse
```
...
```php
appendKeywordTargetsByLineItemId($line_item_id, $keyword_target202110_request): \criteo\api\retailmedia\v2025_01\Model\KeywordTarget202110Response
```
...
try {
    $result = $apiInstance->appendKeywordTargetsByLineItemId($line_item_id, $keyword_target202110_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CampaignApi->appendKeywordTargetsByLineItemId: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
appendStoreTargetsByLineItemId($line_item_id, $store_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\StoreTarget202110Response
```
...
```php
createCampaignsByAccountId($account_id, $post_campaign_v202301): \criteo\api\retailmedia\v2025_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
$post_campaign_v202301 = new \criteo\api\retailmedia\v2025_01\Model\PostCampaignV202301(); // \criteo\api\retailmedia\v2025_01\Model\PostCampaignV202301 | The campaign settings to create a campaign with
...
| **post_campaign_v202301** | [**\criteo\api\retailmedia\v2025_01\Model\PostCampaignV202301**](../Model/PostCampaignV202301.md)| The campaign settings to create a campaign with | [optional] |
...
```php
createCreative($account_id, $creative_create_model202207): \criteo\api\retailmedia\v2025_01\Model\Creative202210Response
```
...
```php
createPreferredLineItemByCampaignId($campaign_id, $preferred_line_item_create_model_v2_request): \criteo\api\retailmedia\v2025_01\Model\PreferredLineItemV2Response
```
...
| **preferred_line_item_create_model_v2_request** | [**\criteo\api\retailmedia\v2025_01\Model\PreferredLineItemCreateModelV2Request**](../Model/PreferredLineItemCreateModelV2Request.md)| The line item settings to create a line item with | [optional] |
...
```php
deleteAddToBasketTargetsByLineItemId($line_item_id, $add_to_basket_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\AddToBasketTarget202110Response
```
...
```php
deleteAudienceTargetsByLineItemId($line_item_id, $audience_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\AudienceTarget202110Response
```
...
```php
deleteCampaignsByBalanceId($balance_id, $balance_campaign202110_list_request): \criteo\api\retailmedia\v2025_01\Model\BalanceCampaign202110PagedListResponse
```
...
```php
deleteKeywordTargetsByLineItemId($line_item_id, $keyword_target202110_request): \criteo\api\retailmedia\v2025_01\Model\KeywordTarget202110Response
```
...
try {
    $result = $apiInstance->deleteKeywordTargetsByLineItemId($line_item_id, $keyword_target202110_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CampaignApi->deleteKeywordTargetsByLineItemId: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteStoreTargetByLineItemId($line_item_id, $store_ids_update_model202110_request): \criteo\api\retailmedia\v2025_01\Model\StoreTarget202110Response
```
...
```php
getAccountCreatives($account_id): \criteo\api\retailmedia\v2025_01\Model\Creative202110ListResponse
```
...
```php
getAddToBasketTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\AddToBasketTarget202110Response
```
...
```php
getAuctionLineItemsByCampaignId($campaign_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\AuctionLineItemPagedListResponse
```
...
```php
getAuctionLineItemsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\AuctionLineItemResponse
```
...
```php
getAudienceTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\AudienceTarget202110Response
```
...
```php
getBidMultipliersByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2
```
...
```php
getBrandsByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\JsonApiPageResponseOfBrand
```
...
```php
getCampaignByCampaignId($campaign_id): \criteo\api\retailmedia\v2025_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
```php
getCampaignsByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\JsonApiPageResponseOfCampaignV202301
```
...
```php
getCreative($account_id, $creative_id): \criteo\api\retailmedia\v2025_01\Model\Creative2Response
```
...
```php
getCreativeTemplate($retailer_id, $template_id): \criteo\api\retailmedia\v2025_01\Model\TemplateResponse
```
...
```php
getKeywordTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\KeywordTarget202110Response
```
...
try {
    $result = $apiInstance->getKeywordTargetsByLineItemId($line_item_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CampaignApi->getKeywordTargetsByLineItemId: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getLineItemsByAccountId($account_id, $limit_to_campaign_id, $limit_to_id, $limit_to_type, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\CommonLineItemPagedListResponse
```
...
```php
getLineItemsByCampaignId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\CommonLineItemResponse
```
...
```php
getPreferredLineItemsByCampaignId($campaign_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\PreferredLineItemV2PagedListResponse
```
...
```php
getPreferredLineItemsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\PreferredLineItemV2Response
```
...
```php
getRetailerCreativeTemplates($retailer_id): \criteo\api\retailmedia\v2025_01\Model\TemplateListResponse
```
...
```php
getRetailersByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2025_01\Model\JsonApiPageResponseOfRetailer
```
...
```php
getStoreTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2025_01\Model\StoreTarget202110Response
```
...
```php
modifyAuctionLineItemsByCampaignId($campaign_id, $auction_line_item_create_model_request): \criteo\api\retailmedia\v2025_01\Model\AuctionLineItemResponse
```
...
```php
putAddToBasketTargetByLineItemId($line_item_id, $add_to_basket_target202110_request): \criteo\api\retailmedia\v2025_01\Model\AddToBasketTarget202110Response
```
...
```php
putAudienceTargetsByLineItemId($line_item_id, $audience_target202110_request): \criteo\api\retailmedia\v2025_01\Model\AudienceTarget202110Response
```
...
```php
putStoreTargetByLineItemId($line_item_id, $store_target202110_request): \criteo\api\retailmedia\v2025_01\Model\StoreTarget202110Response
```
...
```php
searchAccountCreatives($account_id, $creative_ids): \criteo\api\retailmedia\v2025_01\Model\Creative2ListResponse
```
...
```php
updateAuctionLineItemByLineItemId($line_item_id, $auction_line_item_update_model_request): \criteo\api\retailmedia\v2025_01\Model\AuctionLineItemResponse
```
...
```php
updateBidMultipliersByLineItemId($line_item_id, $line_item_bid_multipliers_v2_request): \criteo\api\retailmedia\v2025_01\Model\LineItemBidMultipliersV2Response
```
...
```php
updateCampaignByCampaignId($campaign_id, $put_campaign_v202301): \criteo\api\retailmedia\v2025_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
$campaign_id = 'campaign_id_example'; // string | The given campaign id
$put_campaign_v202301 = new \criteo\api\retailmedia\v2025_01\Model\PutCampaignV202301(); // \criteo\api\retailmedia\v2025_01\Model\PutCampaignV202301 | The campaign settings to update that campaign with
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| The given campaign id | |
| **put_campaign_v202301** | [**\criteo\api\retailmedia\v2025_01\Model\PutCampaignV202301**](../Model/PutCampaignV202301.md)| The campaign settings to update that campaign with | [optional] |
...
```php
updateCreative($account_id, $creative_id, $creative_update_model202207): \criteo\api\retailmedia\v2025_01\Model\Creative202210Response
```
...
```php
updatePreferredLineItemByLineItemId($line_item_id, $preferred_line_item_update_model_v2_request): \criteo\api\retailmedia\v2025_01\Model\PreferredLineItemV2Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The given line item id | |
| **preferred_line_item_update_model_v2_request** | [**\criteo\api\retailmedia\v2025_01\Model\PreferredLineItemUpdateModelV2Request**](../Model/PreferredLineItemUpdateModelV2Request.md)| The line item settings to create a line item with | [optional] |
