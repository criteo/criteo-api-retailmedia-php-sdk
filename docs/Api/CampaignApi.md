...
```php
fetchProposal($id): \criteo\api\retailmedia\v2024_07\Model\ProposalStatusModelResponse
```
...
[**\criteo\api\retailmedia\v2024_07\Model\ProposalStatusModelResponse**](../Model/ProposalStatusModelResponse.md)
...
```php
submitProposal($id): \criteo\api\retailmedia\v2024_07\Model\ProposalStatusModelResponse
```
