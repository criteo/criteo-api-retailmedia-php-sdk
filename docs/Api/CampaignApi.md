...
$line_item_id = 'line_item_id_example'; // string | The line item ID of the sponsored products line item.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item ID of the sponsored products line item. | |
