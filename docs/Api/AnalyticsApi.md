# criteo\api\retailmedia\v2025_01\AnalyticsApi
...
```php
generateAsyncCampaignsReport($async_campaigns_report_request): \criteo\api\retailmedia\v2025_01\Model\AsyncReportResponse
```
...
$apiInstance = new criteo\api\retailmedia\v2025_01\Api\AnalyticsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$async_campaigns_report_request = new \criteo\api\retailmedia\v2025_01\Model\AsyncCampaignsReportRequest(); // \criteo\api\retailmedia\v2025_01\Model\AsyncCampaignsReportRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **async_campaigns_report_request** | [**\criteo\api\retailmedia\v2025_01\Model\AsyncCampaignsReportRequest**](../Model/AsyncCampaignsReportRequest.md)|  | |

### Return type

[**\criteo\api\retailmedia\v2025_01\Model\AsyncReportResponse**](../Model/AsyncReportResponse.md)
...
```php
generateAsyncLineItemsReport($async_line_items_report_request): \criteo\api\retailmedia\v2025_01\Model\AsyncReportResponse
```
...
$async_line_items_report_request = new \criteo\api\retailmedia\v2025_01\Model\AsyncLineItemsReportRequest(); // \criteo\api\retailmedia\v2025_01\Model\AsyncLineItemsReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **async_line_items_report_request** | [**\criteo\api\retailmedia\v2025_01\Model\AsyncLineItemsReportRequest**](../Model/AsyncLineItemsReportRequest.md)|  | |
...
```php
generateAsyncRevenueReport($async_revenue_report_request): \criteo\api\retailmedia\v2025_01\Model\AsyncReportResponse
```
...
$async_revenue_report_request = new \criteo\api\retailmedia\v2025_01\Model\AsyncRevenueReportRequest(); // \criteo\api\retailmedia\v2025_01\Model\AsyncRevenueReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **async_revenue_report_request** | [**\criteo\api\retailmedia\v2025_01\Model\AsyncRevenueReportRequest**](../Model/AsyncRevenueReportRequest.md)|  | |
...
```php
getAsyncExportStatus($report_id): \criteo\api\retailmedia\v2025_01\Model\AsyncReportResponse
```
