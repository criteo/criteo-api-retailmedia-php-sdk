...
```php
getReportStatus($report_id): \criteo\api\retailmedia\v2023_01\Model\EnvelopeReportStatus
```
...
[**\criteo\api\retailmedia\v2023_01\Model\EnvelopeReportStatus**](../Model/EnvelopeReportStatus.md)
...
```php
requestCampaignReport($envelope_report_request): \criteo\api\retailmedia\v2023_01\Model\EnvelopeReportStatus
```
...
$envelope_report_request = new \criteo\api\retailmedia\v2023_01\Model\EnvelopeReportRequest(); // \criteo\api\retailmedia\v2023_01\Model\EnvelopeReportRequest | Envelope of the request
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **envelope_report_request** | [**\criteo\api\retailmedia\v2023_01\Model\EnvelopeReportRequest**](../Model/EnvelopeReportRequest.md)| Envelope of the request | |
...
```php
requestLineItemReport($envelope_report_request): \criteo\api\retailmedia\v2023_01\Model\EnvelopeReportStatus
```
