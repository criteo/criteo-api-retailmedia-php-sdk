...
```php
generateAsyncAccountsReport($async_accounts_report_request): \criteo\api\retailmedia\v2026_07\Model\AsyncReportResponse
```
...
$async_accounts_report_request = new \criteo\api\retailmedia\v2026_07\Model\AsyncAccountsReportRequest(); // \criteo\api\retailmedia\v2026_07\Model\AsyncAccountsReportRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **async_accounts_report_request** | [**\criteo\api\retailmedia\v2026_07\Model\AsyncAccountsReportRequest**](../Model/AsyncAccountsReportRequest.md)|  | |
...
```php
generateAsyncCampaignsReport($async_campaigns_report_request): \criteo\api\retailmedia\v2026_07\Model\AsyncReportResponse
```
...
$async_campaigns_report_request = new \criteo\api\retailmedia\v2026_07\Model\AsyncCampaignsReportRequest(); // \criteo\api\retailmedia\v2026_07\Model\AsyncCampaignsReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **async_campaigns_report_request** | [**\criteo\api\retailmedia\v2026_07\Model\AsyncCampaignsReportRequest**](../Model/AsyncCampaignsReportRequest.md)|  | |
...
```php
generateAsyncLineItemsReport($async_line_items_report_request): \criteo\api\retailmedia\v2026_07\Model\AsyncReportResponse
```
...
$async_line_items_report_request = new \criteo\api\retailmedia\v2026_07\Model\AsyncLineItemsReportRequest(); // \criteo\api\retailmedia\v2026_07\Model\AsyncLineItemsReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **async_line_items_report_request** | [**\criteo\api\retailmedia\v2026_07\Model\AsyncLineItemsReportRequest**](../Model/AsyncLineItemsReportRequest.md)|  | |
