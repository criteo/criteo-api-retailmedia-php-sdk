# criteo\api\retailmedia\v2024_10\BalanceApi
...
```php
getApi202110ExternalBalanceCampaignsByBalanceId($balance_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2024_10\Model\BalanceCampaign202110PagedListResponse
```
...
$apiInstance = new criteo\api\retailmedia\v2024_10\Api\BalanceApi(
...
```php
getApiV2ExternalAccountBalancesByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2024_10\Model\PagedResourceCollectionOutcomeOfBalanceResponseV2
```
...
[**\criteo\api\retailmedia\v2024_10\Model\PagedResourceCollectionOutcomeOfBalanceResponseV2**](../Model/PagedResourceCollectionOutcomeOfBalanceResponseV2.md)
...
```php
getApiV2ExternalAccountByAccountIdBalancesbalanceId($account_id, $balance_id): \criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response
```
...
[**\criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response**](../Model/BalanceResponseV2Response.md)
...
```php
getBalanceHistory($balance_id, $limit, $limit_to_change_types, $offset): \criteo\api\retailmedia\v2024_10\Model\PageOfBalanceHistoryChangeDataCaptureV1
```
...
[**\criteo\api\retailmedia\v2024_10\Model\PageOfBalanceHistoryChangeDataCaptureV1**](../Model/PageOfBalanceHistoryChangeDataCaptureV1.md)
...
```php
patchApiV2ExternalAccountByAccountIdBalancesbalanceId($account_id, $balance_id, $update_balance_model_v2_request): \criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response
```
...
$update_balance_model_v2_request = new \criteo\api\retailmedia\v2024_10\Model\UpdateBalanceModelV2Request(); // \criteo\api\retailmedia\v2024_10\Model\UpdateBalanceModelV2Request | An object that represents the available options to modify a balance.
...
| **update_balance_model_v2_request** | [**\criteo\api\retailmedia\v2024_10\Model\UpdateBalanceModelV2Request**](../Model/UpdateBalanceModelV2Request.md)| An object that represents the available options to modify a balance. | |
...
```php
postApiV2ExternalAccountAddFundsByAccountIdBalancesbalanceId($account_id, $balance_id, $add_funds_to_balance_v2_request): \criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response
```
...
$add_funds_to_balance_v2_request = new \criteo\api\retailmedia\v2024_10\Model\AddFundsToBalanceV2Request(); // \criteo\api\retailmedia\v2024_10\Model\AddFundsToBalanceV2Request | An object that represents the available options of adding funds to a balance.
...
| **add_funds_to_balance_v2_request** | [**\criteo\api\retailmedia\v2024_10\Model\AddFundsToBalanceV2Request**](../Model/AddFundsToBalanceV2Request.md)| An object that represents the available options of adding funds to a balance. | |
...
```php
postApiV2ExternalAccountBalancesByAccountId($account_id, $create_balance_v2_request): \criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response
```
...
$create_balance_v2_request = new \criteo\api\retailmedia\v2024_10\Model\CreateBalanceV2Request(); // \criteo\api\retailmedia\v2024_10\Model\CreateBalanceV2Request | An object that represents the available options to set when creating a Retail Media Balance
...
| **create_balance_v2_request** | [**\criteo\api\retailmedia\v2024_10\Model\CreateBalanceV2Request**](../Model/CreateBalanceV2Request.md)| An object that represents the available options to set when creating a Retail Media Balance | |
...
```php
postApiV2ExternalAccountChangeDatesByAccountIdBalancesbalanceId($account_id, $balance_id, $change_dates_of_balance_v2_request): \criteo\api\retailmedia\v2024_10\Model\BalanceResponseV2Response
```
...
$account_id = 'account_id_example'; // string | The account of the balance
$balance_id = 'balance_id_example'; // string | The balance to change the dates
$change_dates_of_balance_v2_request = new \criteo\api\retailmedia\v2024_10\Model\ChangeDatesOfBalanceV2Request(); // \criteo\api\retailmedia\v2024_10\Model\ChangeDatesOfBalanceV2Request | An object that represents the available options to modify schedule of a balance.
...
| **account_id** | **string**| The account of the balance | |
| **balance_id** | **string**| The balance to change the dates | |
| **change_dates_of_balance_v2_request** | [**\criteo\api\retailmedia\v2024_10\Model\ChangeDatesOfBalanceV2Request**](../Model/ChangeDatesOfBalanceV2Request.md)| An object that represents the available options to modify schedule of a balance. | |
