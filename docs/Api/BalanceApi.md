...
```php
getApiV1ExternalAccountBalancesByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2024_07\Model\BalanceResponsePagedListResponse
```
...
[**\criteo\api\retailmedia\v2024_07\Model\BalanceResponsePagedListResponse**](../Model/BalanceResponsePagedListResponse.md)
...
```php
getApiV1ExternalAccountByAccountIdAndBalanceId($account_id, $balance_id): \criteo\api\retailmedia\v2024_07\Model\BalanceResponse
```
...
[**\criteo\api\retailmedia\v2024_07\Model\BalanceResponse**](../Model/BalanceResponse.md)
...
```php
patchApiV1ExternalAccountByAccountIdAndBalanceId($account_id, $balance_id, $update_balance_model_request): \criteo\api\retailmedia\v2024_07\Model\BalanceResponse
```
...
$update_balance_model_request = new \criteo\api\retailmedia\v2024_07\Model\UpdateBalanceModelRequest(); // \criteo\api\retailmedia\v2024_07\Model\UpdateBalanceModelRequest
...
| **update_balance_model_request** | [**\criteo\api\retailmedia\v2024_07\Model\UpdateBalanceModelRequest**](../Model/UpdateBalanceModelRequest.md)|  | [optional] |
...
```php
postApiV1ExternalAccountAddFundsByAccountIdAndBalanceId($account_id, $balance_id, $add_funds_to_balance_request): \criteo\api\retailmedia\v2024_07\Model\BalanceResponse
```
...
$add_funds_to_balance_request = new \criteo\api\retailmedia\v2024_07\Model\AddFundsToBalanceRequest(); // \criteo\api\retailmedia\v2024_07\Model\AddFundsToBalanceRequest
...
| **add_funds_to_balance_request** | [**\criteo\api\retailmedia\v2024_07\Model\AddFundsToBalanceRequest**](../Model/AddFundsToBalanceRequest.md)|  | [optional] |
...
```php
postApiV1ExternalAccountBalancesByAccountId($account_id, $create_balance_request): \criteo\api\retailmedia\v2024_07\Model\BalanceResponse
```
...
$create_balance_request = new \criteo\api\retailmedia\v2024_07\Model\CreateBalanceRequest(); // \criteo\api\retailmedia\v2024_07\Model\CreateBalanceRequest
...
| **create_balance_request** | [**\criteo\api\retailmedia\v2024_07\Model\CreateBalanceRequest**](../Model/CreateBalanceRequest.md)|  | [optional] |
...
```php
postApiV1ExternalAccountChangeDatesByAccountIdAndBalanceId($account_id, $balance_id, $change_dates_of_balance_request): \criteo\api\retailmedia\v2024_07\Model\BalanceResponse
```
...
$account_id = 'account_id_example'; // string | The account of the balance
$balance_id = 'balance_id_example'; // string | The balance to change the dates
$change_dates_of_balance_request = new \criteo\api\retailmedia\v2024_07\Model\ChangeDatesOfBalanceRequest(); // \criteo\api\retailmedia\v2024_07\Model\ChangeDatesOfBalanceRequest
...
| **account_id** | **string**| The account of the balance | |
| **balance_id** | **string**| The balance to change the dates | |
| **change_dates_of_balance_request** | [**\criteo\api\retailmedia\v2024_07\Model\ChangeDatesOfBalanceRequest**](../Model/ChangeDatesOfBalanceRequest.md)|  | [optional] |
