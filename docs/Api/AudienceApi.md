...
```php
legacyGetAudienceV1($account_id, $limit_to_id, $page_size, $page_index): \criteo\api\retailmedia\v2024_07\Model\RmLegacyAudienceGetEntityV1ListResponse
```
...
```php
legacyGetAudienceV2($account_id, $limit_to_id, $page_size, $page_index): \criteo\api\retailmedia\v2024_07\Model\RmLegacyAudienceGetEntityV2ListResponse
```
