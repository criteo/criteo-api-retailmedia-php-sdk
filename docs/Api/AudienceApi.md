...
```php
createAudience($account_id, $create_retail_media_audience_request): \criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceResponse
```
...
$create_retail_media_audience_request = new \criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceRequest(); // \criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceRequest
...
| **create_retail_media_audience_request** | [**\criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceRequest**](../Model/CreateRetailMediaAudienceRequest.md)|  | |

### Return type

[**\criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceResponse**](../Model/CreateRetailMediaAudienceResponse.md)
...
```php
createRetailMediaAudienceV2($account_id, $create_retail_media_audience_v2_request): \criteo\api\retailmedia\v2023_07\Model\RetailMediaAudienceV2Response
```
...
$account_id = 56; // int | ID of the account to which this audience belongs.
$create_retail_media_audience_v2_request = new \criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceV2Request(); // \criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceV2Request
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **int**| ID of the account to which this audience belongs. | |
| **create_retail_media_audience_v2_request** | [**\criteo\api\retailmedia\v2023_07\Model\CreateRetailMediaAudienceV2Request**](../Model/CreateRetailMediaAudienceV2Request.md)|  | |

### Return type

[**\criteo\api\retailmedia\v2023_07\Model\RetailMediaAudienceV2Response**](../Model/RetailMediaAudienceV2Response.md)
...
```php
getAudiencesByAccountId($account_id, $limit_to_id, $page_size, $page_index): \criteo\api\retailmedia\v2023_07\Model\GetPageOfAudiencesByAccountIdResponse
```
...
[**\criteo\api\retailmedia\v2023_07\Model\GetPageOfAudiencesByAccountIdResponse**](../Model/GetPageOfAudiencesByAccountIdResponse.md)
...
```php
getRetailMediaAudienceV2ListByAccountId($account_id, $limit_to_id, $page_size, $page_index): \criteo\api\retailmedia\v2023_07\Model\RetailMediaAudienceV2ListResponse
```
...
[**\criteo\api\retailmedia\v2023_07\Model\RetailMediaAudienceV2ListResponse**](../Model/RetailMediaAudienceV2ListResponse.md)
