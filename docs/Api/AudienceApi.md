...
```php
legacyGetAudienceV1($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2024_01\Model\RmLegacyAudienceGetEntityV1ListResponse
```
...
```php
legacyGetAudienceV2($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2024_01\Model\RmLegacyAudienceGetEntityV2ListResponse
```
