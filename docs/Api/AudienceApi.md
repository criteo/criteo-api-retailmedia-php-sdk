# criteo\api\retailmedia\v2022_01\AudienceApi
...
```php
createAudience($account_id, $create_retail_media_audience_request): \criteo\api\retailmedia\v2022_01\Model\CreateRetailMediaAudienceResponse
```
...
$apiInstance = new criteo\api\retailmedia\v2022_01\Api\AudienceApi(
...
$create_retail_media_audience_request = new \criteo\api\retailmedia\v2022_01\Model\CreateRetailMediaAudienceRequest(); // \criteo\api\retailmedia\v2022_01\Model\CreateRetailMediaAudienceRequest
 ...
 **create_retail_media_audience_request** | [**\criteo\api\retailmedia\v2022_01\Model\CreateRetailMediaAudienceRequest**](../Model/CreateRetailMediaAudienceRequest.md)|  |

### Return type

[**\criteo\api\retailmedia\v2022_01\Model\CreateRetailMediaAudienceResponse**](../Model/CreateRetailMediaAudienceResponse.md)
...
```php
getAudiencesByAccountId($account_id, $limit_to_id, $page_size, $page_index): \criteo\api\retailmedia\v2022_01\Model\GetPageOfAudiencesByAccountIdResponse
```
...
[**\criteo\api\retailmedia\v2022_01\Model\GetPageOfAudiencesByAccountIdResponse**](../Model/GetPageOfAudiencesByAccountIdResponse.md)
