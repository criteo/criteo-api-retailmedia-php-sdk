# criteo\api\retailmedia\v2022_04\OAuthApi
...
```php
getToken($grant_type, $client_id, $client_secret, $redirect_uri, $code, $refresh_token): \criteo\api\retailmedia\v2022_04\Model\AccessTokenModel
```
...
$apiInstance = new criteo\api\retailmedia\v2022_04\Api\OAuthApi(
...
[**\criteo\api\retailmedia\v2022_04\Model\AccessTokenModel**](../Model/AccessTokenModel.md)
