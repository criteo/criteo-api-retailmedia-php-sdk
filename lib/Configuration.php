...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2020.10.0.211215/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\retailmedia\v2020_10) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2021-10' . PHP_EOL;
        $report .= '    SDK Package Version: 2020.10.0.211215' . PHP_EOL;
