...
/**
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncCampaignsReportRequest $async_campaigns_report_request async_campaigns_report_request (required)
     ...
     * @return \criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome
     */
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncCampaignsReportRequest $async_campaigns_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateAsyncCampaignsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateAsyncCampaignsReportWithHttpInfo($async_campaigns_report_request, string $contentType = self::contentTypes['generateAsyncCampaignsReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\criteo\api\retailmedia\v2024_07\Model\ReportOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_07\Model\ReportOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_07\Model\ReportOutcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_07\Model\AsyncReportResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_07\Model\ReportOutcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function generateAsyncCampaignsReportRequest($async_campaigns_report_request, string $contentType = self::contentTypes['generateAsyncCampaignsReport'][0])
    {
        ...
        $resourcePath = '/2024-07/retail-media/reports/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncLineItemsReportRequest $async_line_items_report_request async_line_items_report_request (required)
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncLineItemsReportRequest $async_line_items_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateAsyncLineItemsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function generateAsyncLineItemsReportRequest($async_line_items_report_request, string $contentType = self::contentTypes['generateAsyncLineItemsReport'][0])
    {
        ...
        $resourcePath = '/2024-07/retail-media/reports/line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncRevenueReportRequest $async_revenue_report_request async_revenue_report_request (required)
     ...
     *
     * @param  \criteo\api\retailmedia\v2024_07\Model\AsyncRevenueReportRequest $async_revenue_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateAsyncRevenueReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function generateAsyncRevenueReportRequest($async_revenue_report_request, string $contentType = self::contentTypes['generateAsyncRevenueReport'][0])
    {
        ...
        $resourcePath = '/2024-07/retail-media/reports/revenue';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome|\criteo\api\retailmedia\v2024_07\Model\ReportOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getAsyncExportOutputRequest($report_id, string $contentType = self::contentTypes['getAsyncExportOutput'][0])
    {
        ...
        $resourcePath = '/2024-07/retail-media/reports/{reportId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getAsyncExportStatusRequest($report_id, string $contentType = self::contentTypes['getAsyncExportStatus'][0])
    {
        ...
        $resourcePath = '/2024-07/retail-media/reports/{reportId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
