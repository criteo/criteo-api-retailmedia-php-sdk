...
class AnalyticsApi
{
    ...
    public function getReportOutputRequest($report_id)
    {
        ...
        $resourcePath = '/2022-01/retail-media/reports/{reportId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2022_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportStatusWithHttpInfo($report_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getReportStatusRequest($report_id)
    {
        ...
        $resourcePath = '/2022-01/retail-media/reports/{reportId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2022_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_01\Model\EnvelopeReportStatus|\criteo\api\retailmedia\v2022_01\Model\BadRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestCampaignReportWithHttpInfo($envelope_report_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\retailmedia\v2022_01\Model\BadRequest' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_01\Model\BadRequest', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_01\Model\BadRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function requestCampaignReportRequest($envelope_report_request)
    {
        ...
        $resourcePath = '/2022-01/retail-media/reports/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function requestLineItemReportRequest($envelope_report_request)
    {
        ...
        $resourcePath = '/2022-01/retail-media/reports/line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
