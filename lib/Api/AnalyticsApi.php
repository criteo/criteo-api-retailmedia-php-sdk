...
/**
     ...
     * @return \criteo\api\retailmedia\v2025_07\Model\AsyncReportResponse|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AsyncReportResponse|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateAsyncCampaignsReportWithHttpInfo($async_campaigns_report_request, string $contentType = self::contentTypes['generateAsyncCampaignsReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ReportOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ReportOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ReportOutcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ReportOutcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome|\criteo\api\retailmedia\v2025_07\Model\ReportOutcome, HTTP status code, HTTP response headers (array of strings)
     */
