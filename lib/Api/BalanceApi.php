...
/**
    ...
    public function addFundsByAccountAndBalanceIdWithHttpInfo($account_id, $balance_id, $add_funds_to_balance_v2_request, string $contentType = self::contentTypes['addFundsByAccountAndBalanceId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2Response', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2Response',
     ...
     * @throws \criteo\api\retailmedia\v2025_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalanceHistoryWithHttpInfo($balance_id, $limit = 25, $limit_to_change_types = null, $offset = 0, string $contentType = self::contentTypes['getBalanceHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_10\Model\PageOfBalanceHistoryChangeDataCaptureV1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getBalanceHistoryRequest($balance_id, $limit = 25, $limit_to_change_types = null, $offset = 0, string $contentType = self::contentTypes['getBalanceHistory'][0])
    {
        ...
        $resourcePath = '/2025-10/retail-media/balances/{balanceId}/history';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalancesByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getBalancesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_10\Model\BalanceResponseV2PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCampaignsByBalanceIdRequest($balance_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getCampaignsByBalanceId'][0])
    {
        ...
        $resourcePath = '/2025-10/retail-media/balances/{balance-id}/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
