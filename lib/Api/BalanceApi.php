...
/**
     ...
     * @param  \criteo\api\retailmedia\v2025_01\Model\AddFundsToBalanceV2Request $add_funds_to_balance_v2_request An object that represents the available options of adding funds to a balance. (optional)
     ...
     * @param  \criteo\api\retailmedia\v2025_01\Model\ChangeDatesOfBalanceV2Request $change_dates_of_balance_v2_request An object that represents the available options to modify schedule of a balance. (optional)
     ...
     * @param  \criteo\api\retailmedia\v2025_01\Model\CreateBalanceV2Request $create_balance_v2_request An object that represents the available options to set when creating a Retail Media Balance (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalancesByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getBalancesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_01\Model\BalanceResponseV2PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $account_id The account of the balance (required)
     * @param  string $balance_id The balance to change the dates (required)
     * @param  \criteo\api\retailmedia\v2025_01\Model\UpdateBalanceModelV2Request $update_balance_model_v2_request An object that represents the available options to modify a balance. (optional)
