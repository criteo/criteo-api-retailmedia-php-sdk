...
/**
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AssetResponse' === '\SplFileObject') {
                        ...
                        if ('\criteo\api\retailmedia\v2023_01\Model\AssetResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\Balance202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\Balance202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\Creative202110ListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\Creative202110ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\KeywordTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\KeywordTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\BalanceCampaign202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\BalanceCampaign202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\PreferredLineItem202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\PreferredLineItem202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\PromotedProduct202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\PromotedProduct202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\PreferredLineItem202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\PreferredLineItem202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AddToBasketTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\AddToBasketTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AudienceTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\AudienceTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\StoreTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\StoreTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\ExternalRetailerPages202110' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\ExternalRetailerPages202110' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\Category202204' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\Category202204' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\Category202204ListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\Category202204ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2023_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2023_01\Model\Creative202207Response
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeId($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        list($response) = $this->getApi202207ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, $contentType);
        return $response;
    }
     ...
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        $request = $this->getApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\Creative202207Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\Creative202207Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdAsync($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        return $this->getApi202207ExternalAccountByAccountIdCreativescreativeIdAsyncWithHttpInfo($account_id, $creative_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdAsyncWithHttpInfo($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        $returnType = '\criteo\api\retailmedia\v2023_01\Model\Creative202207Response';
        $request = $this->getApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\TemplateResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\TemplateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\TemplateListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\TemplateListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfCampaignV202301' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfCampaignV202301' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfLineItemBidMultipliers' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfLineItemBidMultipliers' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfBrand' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfBrand' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfRetailer' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfRetailer' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfAccount' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiPageResponseOfAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfCatalogStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\JsonApiSingleResponseOfCatalogStatus' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\CommonLineItemPagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\CommonLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AuctionLineItemResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\AuctionLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AuctionLineItemPagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\AuctionLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\CommonLineItemResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\CommonLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2023_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2023_01\Model\Creative202207Response
     */
    public function postApi202207ExternalAccountCreativesByAccountId($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'][0])
    {
        list($response) = $this->postApi202207ExternalAccountCreativesByAccountIdWithHttpInfo($account_id, $creative_create_model202207, $contentType);
        return $response;
    }
     ...
     * @return array of \criteo\api\retailmedia\v2023_01\Model\Creative202207Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApi202207ExternalAccountCreativesByAccountIdWithHttpInfo($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'][0])
    {
        $request = $this->postApi202207ExternalAccountCreativesByAccountIdRequest($account_id, $creative_create_model202207, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApi202207ExternalAccountCreativesByAccountIdAsync($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'][0])
    {
        return $this->postApi202207ExternalAccountCreativesByAccountIdAsyncWithHttpInfo($account_id, $creative_create_model202207, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApi202207ExternalAccountCreativesByAccountIdAsyncWithHttpInfo($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'][0])
    {
        $returnType = '\criteo\api\retailmedia\v2023_01\Model\Creative202207Response';
        $request = $this->postApi202207ExternalAccountCreativesByAccountIdRequest($account_id, $creative_create_model202207, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApi202207ExternalAccountCreativesByAccountIdRequest($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202207ExternalAccountCreativesByAccountId'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2023_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2023_01\Model\Creative202207Response
     */
    public function putApi202207ExternalAccountByAccountIdCreativescreativeId($account_id, $creative_id, $creative_update_model202207 = null, string $contentType = self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        list($response) = $this->putApi202207ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, $creative_update_model202207, $contentType);
        return $response;
    }
     ...
     * @return array of \criteo\api\retailmedia\v2023_01\Model\Creative202207Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function putApi202207ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, $creative_update_model202207 = null, string $contentType = self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        $request = $this->putApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, $creative_update_model202207, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putApi202207ExternalAccountByAccountIdCreativescreativeIdAsync($account_id, $creative_id, $creative_update_model202207 = null, string $contentType = self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        return $this->putApi202207ExternalAccountByAccountIdCreativescreativeIdAsyncWithHttpInfo($account_id, $creative_id, $creative_update_model202207, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putApi202207ExternalAccountByAccountIdCreativescreativeIdAsyncWithHttpInfo($account_id, $creative_id, $creative_update_model202207 = null, string $contentType = self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        $returnType = '\criteo\api\retailmedia\v2023_01\Model\Creative202207Response';
        $request = $this->putApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, $creative_update_model202207, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, $creative_update_model202207 = null, string $contentType = self::contentTypes['putApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\LineItemBidMultipliersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\LineItemBidMultipliersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
