...
/**
     ...
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountBalancesByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountBalancesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\preview\Model\BalanceResponsePagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\preview\Model\BalanceResponse
     */
     ...
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\preview\Model\BalanceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountByAccountIdAndBalanceIdWithHttpInfo($account_id, $balance_id, string $contentType = self::contentTypes['getApiV1ExternalAccountByAccountIdAndBalanceId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\preview\Model\BalanceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\BalanceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\preview\Model\BalanceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\preview\Model\BalanceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\preview\Model\BalanceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountByAccountIdAndBalanceIdRequest($account_id, $balance_id, string $contentType = self::contentTypes['getApiV1ExternalAccountByAccountIdAndBalanceId'][0])
    {
        ...
        $resourcePath = '/preview/retail-media/accounts/{accountId}/balances/{balanceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSuggestedKeywords
     *
     * @param  string $external_line_item_id The external line item identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSuggestedKeywords'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult
     */
    public function getSuggestedKeywords($external_line_item_id, string $contentType = self::contentTypes['getSuggestedKeywords'][0])
    {
        list($response) = $this->getSuggestedKeywordsWithHttpInfo($external_line_item_id, $contentType);
        return $response;
    }

    /**
     * Operation getSuggestedKeywordsWithHttpInfo
     *
     * @param  string $external_line_item_id The external line item identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSuggestedKeywords'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSuggestedKeywordsWithHttpInfo($external_line_item_id, string $contentType = self::contentTypes['getSuggestedKeywords'][0])
    {
        $request = $this->getSuggestedKeywordsRequest($external_line_item_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getSuggestedKeywordsAsync
     *
     * @param  string $external_line_item_id The external line item identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSuggestedKeywords'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSuggestedKeywordsAsync($external_line_item_id, string $contentType = self::contentTypes['getSuggestedKeywords'][0])
    {
        return $this->getSuggestedKeywordsAsyncWithHttpInfo($external_line_item_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSuggestedKeywordsAsyncWithHttpInfo
     *
     * @param  string $external_line_item_id The external line item identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSuggestedKeywords'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSuggestedKeywordsAsyncWithHttpInfo($external_line_item_id, string $contentType = self::contentTypes['getSuggestedKeywords'][0])
    {
        $returnType = '\criteo\api\retailmedia\preview\Model\ValueResourceOutcomeOfSuggestedKeywordsResult';
        $request = $this->getSuggestedKeywordsRequest($external_line_item_id, $contentType);
    ...
    /**
     * Create request for operation 'getSuggestedKeywords'
     *
     * @param  string $external_line_item_id The external line item identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSuggestedKeywords'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSuggestedKeywordsRequest($external_line_item_id, string $contentType = self::contentTypes['getSuggestedKeywords'][0])
    {
        ...
        if ($external_line_item_id === null || (is_array($external_line_item_id) && count($external_line_item_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $external_line_item_id when calling getSuggestedKeywords'
            );
        }
     ...
     * @param  \criteo\api\retailmedia\preview\Model\UpdateBalanceModelRequest $update_balance_model_request update_balance_model_request (optional)
     ...
     * @param  string $account_id The account of the balance (required)
     * @param  string $balance_id The balance to change the dates (required)
     * @param  \criteo\api\retailmedia\preview\Model\UpdateBalanceModelRequest $update_balance_model_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchApiV1ExternalAccountByAccountIdAndBalanceId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \criteo\api\retailmedia\preview\Model\AddFundsToBalanceRequest $add_funds_to_balance_request add_funds_to_balance_request (optional)
     ...
     * @param  string $account_id The account of the balance (required)
     * @param  string $balance_id The balance to add funds to (required)
     * @param  \criteo\api\retailmedia\preview\Model\AddFundsToBalanceRequest $add_funds_to_balance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountAddFundsByAccountIdAndBalanceId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postApiV1ExternalAccountAddFundsByAccountIdAndBalanceIdRequest($account_id, $balance_id, $add_funds_to_balance_request = null, string $contentType = self::contentTypes['postApiV1ExternalAccountAddFundsByAccountIdAndBalanceId'][0])
    {
        ...
        $resourcePath = '/preview/retail-media/accounts/{accountId}/balances/{balanceId}/add-funds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\preview\Model\CreateBalanceRequest $create_balance_request create_balance_request (optional)
     ...
     *
     * @param  string $account_id The account to create balances for (required)
     * @param  \criteo\api\retailmedia\preview\Model\CreateBalanceRequest $create_balance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountBalancesByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $account_id The account of the balance (required)
     * @param  string $balance_id The balance to change the dates (required)
     * @param  \criteo\api\retailmedia\preview\Model\ChangeDatesOfBalanceRequest $change_dates_of_balance_request change_dates_of_balance_request (optional)
     ...
     * @param  string $account_id The account of the balance (required)
     * @param  string $balance_id The balance to change the dates (required)
     * @param  \criteo\api\retailmedia\preview\Model\ChangeDatesOfBalanceRequest $change_dates_of_balance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountChangeDatesByAccountIdAndBalanceId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postApiV1ExternalAccountChangeDatesByAccountIdAndBalanceIdRequest($account_id, $balance_id, $change_dates_of_balance_request = null, string $contentType = self::contentTypes['postApiV1ExternalAccountChangeDatesByAccountIdAndBalanceId'][0])
    {
        ...
        $resourcePath = '/preview/retail-media/accounts/{accountId}/balances/{balanceId}/change-dates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
