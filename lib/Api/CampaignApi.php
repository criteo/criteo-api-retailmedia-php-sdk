...
/**
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2022_07\Model\AssetResponse' === '\SplFileObject') {
                        ...
                        if ('\criteo\api\retailmedia\v2022_07\Model\AssetResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\Balance202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\Balance202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\Creative202110ListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\Creative202110ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\KeywordTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\KeywordTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\BalanceCampaign202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\BalanceCampaign202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\PreferredLineItem202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\PreferredLineItem202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\PromotedProduct202110PagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\PromotedProduct202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\PreferredLineItem202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\PreferredLineItem202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\AddToBasketTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\AddToBasketTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\AudienceTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\AudienceTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\StoreTarget202110Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\StoreTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\ExternalRetailerPages202110' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\ExternalRetailerPages202110' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\Category202204' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\Category202204' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\Category202204ListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\Category202204ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2022_07\Model\Creative202207Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_07\Model\Creative202207Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\Creative202207Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\Creative202207Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_07\Model\Creative202207Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_07\Model\Creative202207Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_07\Model\Creative202207Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, string $contentType = self::contentTypes['getApi202207ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        $resourcePath = '/2022-07/retail-media/accounts/{account-id}/creatives/{creative-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2022_07\Model\TemplateResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_07\Model\TemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdWithHttpInfo($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\TemplateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\TemplateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_07\Model\TemplateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_07\Model\TemplateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_07\Model\TemplateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdRequest($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        $resourcePath = '/2022-07/retail-media/retailers/{retailer-id}/templates/{template-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2022_07\Model\TemplateListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_07\Model\TemplateListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerTemplatesByRetailerIdWithHttpInfo($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\TemplateListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\TemplateListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_07\Model\TemplateListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_07\Model\TemplateListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_07\Model\TemplateListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerTemplatesByRetailerIdRequest($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        $resourcePath = '/2022-07/retail-media/retailers/{retailer-id}/templates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfBrand' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfBrand' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfCampaign' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfCampaign' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfRetailer' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfRetailer' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfAccount' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiPageResponseOfAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiSingleResponseOfCampaign' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiSingleResponseOfCampaign' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiSingleResponseOfCatalogStatus' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\JsonApiSingleResponseOfCatalogStatus' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\CommonLineItemPagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\CommonLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\AuctionLineItemResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\AuctionLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\AuctionLineItemPagedListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\AuctionLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_07\Model\CommonLineItemResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_07\Model\CommonLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @param  \criteo\api\retailmedia\v2022_07\Model\CreativeCreateModel202207 $creative_create_model202207 The creative to create (optional)
     ...
     *
     * @param  string $line_item_id The given line item id (required)
     * @param  \criteo\api\retailmedia\v2022_07\Model\PreferredLineItemUpdateModel202110Request $preferred_line_item_update_model202110_request The line item settings to create a line item with (optional)
     ...
     * @param  \criteo\api\retailmedia\v2022_07\Model\CreativeUpdateModel202207 $creative_update_model202207 The creative to create (optional)
