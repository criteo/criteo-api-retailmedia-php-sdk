...
/**
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\AddRemoveKeywordsModelRequest $add_remove_keywords_model_request add_remove_keywords_model_request (optional)
     ...
     * @return \criteo\api\retailmedia\v2024_04\Model\ResourceOutcome|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome
     */
     ...
     *
     * @param  string $id ID of the line item (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AddRemoveKeywordsModelRequest $add_remove_keywords_model_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addRemoveKeywords'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\ResourceOutcome|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function addRemoveKeywordsWithHttpInfo($id, $add_remove_keywords_model_request = null, string $contentType = self::contentTypes['addRemoveKeywords'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome', []),
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome',
    ...
    public function addRemoveKeywordsRequest($id, $add_remove_keywords_model_request = null, string $contentType = self::contentTypes['addRemoveKeywords'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{id}/keywords/add-remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\AssetResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\AssetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAssetWithHttpInfo($asset_file, string $contentType = self::contentTypes['createAsset'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2024_04\Model\AssetResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\AssetResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\AssetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\AssetResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\AssetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createAssetRequest($asset_file, string $contentType = self::contentTypes['createAsset'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/assets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchKeywordsWithHttpInfo($id, string $contentType = self::contentTypes['fetchKeywords'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\KeywordsModelResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchKeywordsRequest($id, string $contentType = self::contentTypes['fetchKeywords'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{id}/keywords';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome|\criteo\api\retailmedia\v2024_04\Model\ResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchProposalWithHttpInfo($id, string $contentType = self::contentTypes['fetchProposal'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\ProposalStatusModelResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchProposalRequest($id, string $contentType = self::contentTypes['fetchProposal'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-deal-line-items/{id}/proposal';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalAccountCreativesByAccountIdWithHttpInfo($account_id, string $contentType = self::contentTypes['getApi202110ExternalAccountCreativesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\Creative202110ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalAccountCreativesByAccountIdRequest($account_id, string $contentType = self::contentTypes['getApi202110ExternalAccountCreativesByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{account-id}/creatives';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalAuctionLineItemTargetingKeywordsByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalAuctionLineItemTargetingKeywordsByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalAuctionLineItemTargetingKeywordsByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalAuctionLineItemTargetingKeywordsByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/auction-line-items/{line-item-id}/targeting/keywords';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse|\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse|\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalCampaignPreferredLineItemsByCampaignIdWithHttpInfo($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApi202110ExternalCampaignPreferredLineItemsByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalCampaignPreferredLineItemsByCampaignIdRequest($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApi202110ExternalCampaignPreferredLineItemsByCampaignId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/campaigns/{campaign-id}/preferred-line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalLineItemProductsByLineItemIdWithHttpInfo($line_item_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApi202110ExternalLineItemProductsByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalLineItemProductsByLineItemIdRequest($line_item_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApi202110ExternalLineItemProductsByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response|\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response|\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\PreferredLineItem202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/audiences';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response|\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingStoresByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingStoresByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingStoresByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingStoresByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/stores';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalRetailerPagesByRetailerIdWithHttpInfo($retailer_id, string $contentType = self::contentTypes['getApi202110ExternalRetailerPagesByRetailerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\ExternalRetailerPages202110',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalRetailerPagesByRetailerIdRequest($retailer_id, string $contentType = self::contentTypes['getApi202110ExternalRetailerPagesByRetailerId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/retailers/{retailerId}/pages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\Category202204
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\Category202204, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202204ExternalCategorieByCategoryIdWithHttpInfo($category_id, string $contentType = self::contentTypes['getApi202204ExternalCategorieByCategoryId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\Category202204' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\Category202204' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\Category202204', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\Category202204';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\Category202204',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202204ExternalCategorieByCategoryIdRequest($category_id, string $contentType = self::contentTypes['getApi202204ExternalCategorieByCategoryId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/categories/{categoryId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202204ExternalCategoriesWithHttpInfo($retailer_id = null, $text_substring = null, $page_index = 0, $page_size = 100, string $contentType = self::contentTypes['getApi202204ExternalCategories'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\Category202204ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202204ExternalCategoriesRequest($retailer_id = null, $text_substring = null, $page_index = 0, $page_size = 100, string $contentType = self::contentTypes['getApi202204ExternalCategories'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\TemplateResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\TemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdWithHttpInfo($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\TemplateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\TemplateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\TemplateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\TemplateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\TemplateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdRequest($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/retailers/{retailer-id}/templates/{template-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\TemplateListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\TemplateListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerTemplatesByRetailerIdWithHttpInfo($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\TemplateListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\TemplateListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\TemplateListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\TemplateListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\TemplateListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerTemplatesByRetailerIdRequest($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/retailers/{retailer-id}/templates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\Creative202210Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\Creative202210Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202210ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, string $contentType = self::contentTypes['getApi202210ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\Creative202210Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\Creative202210Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\Creative202210Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\Creative202210Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\Creative202210Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202210ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, string $contentType = self::contentTypes['getApi202210ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{account-id}/creatives/{creative-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202301ExternalAccountCampaignsByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApi202301ExternalAccountCampaignsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfCampaignV202301',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202301ExternalAccountCampaignsByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApi202301ExternalAccountCampaignsByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{account-id}/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202301ExternalCampaignByCampaignIdWithHttpInfo($campaign_id, string $contentType = self::contentTypes['getApi202301ExternalCampaignByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCampaignV202301',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202301ExternalCampaignByCampaignIdRequest($campaign_id, string $contentType = self::contentTypes['getApi202301ExternalCampaignByCampaignId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/campaigns/{campaignId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202301ExternalLineItemBidMultipliersByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202301ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfLineItemBidMultipliers',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202301ExternalLineItemBidMultipliersByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202301ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/bid-multipliers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountBrandsByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountBrandsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfBrand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountBrandsByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountBrandsByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{accountId}/brands';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountRetailersByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountRetailersByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiPageResponseOfRetailer',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountRetailersByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountRetailersByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{accountId}/retailers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getApiV1ExternalCatalogOutputByCatalogIdRequest($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogOutputByCatalogId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/catalogs/{catalogId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalCatalogStatusByCatalogIdWithHttpInfo($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogStatusByCatalogId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\JsonApiSingleResponseOfCatalogStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalCatalogStatusByCatalogIdRequest($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogStatusByCatalogId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/catalogs/{catalogId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalAccountLineItemsByAccountIdWithHttpInfo($account_id, $limit_to_campaign_id = null, $limit_to_type = null, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalAccountLineItemsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemPagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalAccountLineItemsByAccountIdRequest($account_id, $limit_to_campaign_id = null, $limit_to_type = null, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalAccountLineItemsByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{account-id}/line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse|\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse|\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalAuctionLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalAuctionLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalAuctionLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalAuctionLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/auction-line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse|\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse|\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalCampaignAuctionLineItemsByCampaignIdWithHttpInfo($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignAuctionLineItemsByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\AuctionLineItemPagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalCampaignAuctionLineItemsByCampaignIdRequest($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignAuctionLineItemsByCampaignId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/campaigns/{campaign-id}/auction-line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\CommonLineItemResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignBudgetOverridesWithHttpInfo($campaign_id, string $contentType = self::contentTypes['getCampaignBudgetOverrides'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfCampaignBudgetOverrides',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCampaignBudgetOverridesRequest($campaign_id, string $contentType = self::contentTypes['getCampaignBudgetOverrides'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/campaigns/{campaignId}/campaign-budget-overrides';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInsertionOrderHistoryChangeDataCaptureWithHttpInfo($insertion_order_id, $offset = 0, $limit = 25, $limit_to_change_types = null, string $contentType = self::contentTypes['getInsertionOrderHistoryChangeDataCapture'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\PageOfInsertionOrderHistoryChangeDataCapture',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getInsertionOrderHistoryChangeDataCaptureRequest($insertion_order_id, $offset = 0, $limit = 25, $limit_to_change_types = null, string $contentType = self::contentTypes['getInsertionOrderHistoryChangeDataCapture'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/insertion-order-history/{insertionOrderId}/change-data-capture';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLineItemBudgetOverridesWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getLineItemBudgetOverrides'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\ValueResourceOutcomeOfLineItemBudgetOverrides',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getLineItemBudgetOverridesRequest($line_item_id, string $contentType = self::contentTypes['getLineItemBudgetOverrides'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{lineItemId}/line-item-budget-overrides';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\KeywordTarget202110Request $keyword_target202110_request  (optional)
    ...
    public function postApi202110ExternalAuctionLineItemTargetingKeywordsAppendByLineItemIdRequest($line_item_id, $keyword_target202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalAuctionLineItemTargetingKeywordsAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/auction-line-items/{line-item-id}/targeting/keywords/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalAuctionLineItemTargetingKeywordsDeleteByLineItemIdRequest($line_item_id, $keyword_target202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalAuctionLineItemTargetingKeywordsDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/auction-line-items/{line-item-id}/targeting/keywords/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\BalanceCampaign202110ListRequest $balance_campaign202110_list_request The campaigns to append (optional)
    ...
    public function postApi202110ExternalBalanceCampaignsAppendByBalanceIdRequest($balance_id, $balance_campaign202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalBalanceCampaignsAppendByBalanceId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/balances/{balance-id}/campaigns/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalBalanceCampaignsDeleteByBalanceIdRequest($balance_id, $balance_campaign202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalBalanceCampaignsDeleteByBalanceId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/balances/{balance-id}/campaigns/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $campaign_id The given campaign id (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PreferredLineItemCreateModel202110Request $preferred_line_item_create_model202110_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110ListRequest $promoted_product202110_list_request the products to append to this line item (optional)
    ...
    public function postApi202110ExternalLineItemProductsAppendByLineItemIdRequest($line_item_id, $promoted_product202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalLineItemProductsAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/products/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110ListRequest $promoted_product202110_list_request  (optional)
    ...
    public function postApi202110ExternalLineItemProductsDeleteByLineItemIdRequest($line_item_id, $promoted_product202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalLineItemProductsDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/products/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with. (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110ListRequest $promoted_product202110_list_request The products from which their IDs will be used to pause. (optional)
    ...
    public function postApi202110ExternalLineItemProductsPauseByLineItemIdRequest($line_item_id, $promoted_product202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalLineItemProductsPauseByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/products/pause';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with. (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PromotedProduct202110ListRequest $promoted_product202110_list_request The products from which their IDs will be used to unpause. (optional)
    ...
    public function postApi202110ExternalLineItemProductsUnpauseByLineItemIdRequest($line_item_id, $promoted_product202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalLineItemProductsUnpauseByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{line-item-id}/products/unpause';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AddToBasketIdsUpdateModel202110Request $add_to_basket_ids_update_model202110_request Ids to append to the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAddToBasketAppendByLineItemIdRequest($line_item_id, $add_to_basket_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAddToBasketAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AddToBasketIdsUpdateModel202110Request $add_to_basket_ids_update_model202110_request Ids to remove from the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAddToBasketDeleteByLineItemIdRequest($line_item_id, $add_to_basket_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAddToBasketDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AudienceIdsUpdateModel202110Request $audience_ids_update_model202110_request Audience ids to append to the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAudiencesAppendByLineItemIdRequest($line_item_id, $audience_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAudiencesAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/audiences/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AudienceIdsUpdateModel202110Request $audience_ids_update_model202110_request Audience ids to remove from the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAudiencesDeleteByLineItemIdRequest($line_item_id, $audience_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAudiencesDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/audiences/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\StoreIdsUpdateModel202110Request $store_ids_update_model202110_request Store ids to append to the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingStoresAppendByLineItemIdRequest($line_item_id, $store_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingStoresAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/stores/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\StoreIdsUpdateModel202110Request $store_ids_update_model202110_request Store ids to remove from the target (optional)
    ...
    public function postApi202110ExternalPreferredLineItemTargetingStoresDeleteByLineItemIdRequest($line_item_id, $store_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingStoresDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-line-items/{line-item-id}/targeting/stores/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\CreativeCreateModel202207 $creative_create_model202207 The creative to create (optional)
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApi202210ExternalAccountCreativesSearchByAccountIdWithHttpInfo($account_id, $creative_ids = null, string $contentType = self::contentTypes['postApi202210ExternalAccountCreativesSearchByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\Creative202210ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function postApi202210ExternalAccountCreativesSearchByAccountIdRequest($account_id, $creative_ids = null, string $contentType = self::contentTypes['postApi202210ExternalAccountCreativesSearchByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{account-id}/creatives/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The account to request the campaign for. (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PostCampaignV202301 $post_campaign_v202301 Creatable campaign attributes (optional)
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\JsonApiRequestOfCatalogRequest $json_api_request_of_catalog_request json_api_request_of_catalog_request (optional)
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\JsonApiRequestOfCatalogRequest $json_api_request_of_catalog_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountCatalogsByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postApiV1ExternalAccountCatalogsByAccountIdRequest($account_id, $json_api_request_of_catalog_request = null, string $contentType = self::contentTypes['postApiV1ExternalAccountCatalogsByAccountId'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/accounts/{accountId}/catalogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $campaign_id The given campaign id (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemCreateModelRequest $auction_line_item_create_model_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $line_item_id The given line item id (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\PreferredLineItemUpdateModel202110Request $preferred_line_item_update_model202110_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AddToBasketTarget202110Request $add_to_basket_target202110_request The add to basket target to set the scope for (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AudienceTarget202110Request $audience_target202110_request The audience target to set the scope for (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\StoreTarget202110Request $store_target202110_request The store target to set the scope for (optional)
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\CreativeUpdateModel202207 $creative_update_model202207 The creative to create (optional)
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\PutCampaignV202301 $put_campaign_v202301 Editable campaign attributes (optional)
     ...
     *
     * @param  string $line_item_id Long external id of the associated line item (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersRequest $line_item_bid_multipliers_request line_item_bid_multipliers_request (optional)
     ...
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse
     */
     ...
     *
     * @param  string $line_item_id Long external id of the associated line item (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersRequest $line_item_bid_multipliers_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putApi202301ExternalLineItemBidMultipliersByLineItemId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function putApi202301ExternalLineItemBidMultipliersByLineItemIdWithHttpInfo($line_item_id, $line_item_bid_multipliers_request = null, string $contentType = self::contentTypes['putApi202301ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_04\Model\LineItemBidMultipliersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $line_item_id The given line item id (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\AuctionLineItemUpdateModelRequest $auction_line_item_update_model_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $id ID of the line item (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\SetBidsModelRequest $set_bids_model_request set_bids_model_request (optional)
     ...
     *
     * @param  string $id ID of the line item (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\SetBidsModelRequest $set_bids_model_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setKeywordBids'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2024_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function setKeywordBidsRequest($id, $set_bids_model_request = null, string $contentType = self::contentTypes['setKeywordBids'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/line-items/{id}/keywords/set-bid';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function submitProposalRequest($id, string $contentType = self::contentTypes['submitProposal'][0])
    {
        ...
        $resourcePath = '/2024-04/retail-media/preferred-deal-line-items/{id}/proposal/submit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $campaign_id External campaign id. (required)
     * @param  \criteo\api\retailmedia\v2024_04\Model\ValueResourceInputOfCampaignBudgetOverrides $value_resource_input_of_campaign_budget_overrides New campaign budget overrides settings value resource input. (optional)
     ...
     * @param  \criteo\api\retailmedia\v2024_04\Model\ValueResourceInputOfLineItemBudgetOverrides $value_resource_input_of_line_item_budget_overrides New line item budget overrides settings value resource input. (optional)
