...
/**
     ...
     * @return \criteo\api\retailmedia\v2025_07\Model\ResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function addRemoveKeywordsWithHttpInfo($id, $add_remove_keywords_model_request = null, string $contentType = self::contentTypes['addRemoveKeywords'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome', []),
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome',
    ...
    public function addRemoveKeywordsRequest($id, $add_remove_keywords_model_request = null, string $contentType = self::contentTypes['addRemoveKeywords'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{id}/keywords/add-remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function appendPromotedProductsWithHttpInfo($line_item_id, $promoted_product_resource_collection_input = null, string $contentType = self::contentTypes['appendPromotedProducts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function appendPromotedProductsRequest($line_item_id, $promoted_product_resource_collection_input = null, string $contentType = self::contentTypes['appendPromotedProducts'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/products/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\AssetResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AssetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAssetWithHttpInfo($asset_file, string $contentType = self::contentTypes['createAsset'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2025_07\Model\AssetResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\AssetResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\AssetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\AssetResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\AssetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createAssetRequest($asset_file, string $contentType = self::contentTypes['createAsset'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/assets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deletePromotedProductsRequest($line_item_id, $promoted_product_resource_collection_input = null, string $contentType = self::contentTypes['deletePromotedProducts'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/products/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse|\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse|\criteo\api\retailmedia\v2025_07\Model\ResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchKeywordsWithHttpInfo($id, string $contentType = self::contentTypes['fetchKeywords'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\KeywordsModelResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchKeywordsRequest($id, string $contentType = self::contentTypes['fetchKeywords'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{id}/keywords';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome|\criteo\api\retailmedia\v2025_07\Model\ProductResourceOutcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchPromotedProductsWithHttpInfo($line_item_id, $fields = null, $limit = null, $offset = null, string $contentType = self::contentTypes['fetchPromotedProducts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\PromotedProductResourceCollectionOutcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchPromotedProductsRequest($line_item_id, $fields = null, $limit = null, $offset = null, string $contentType = self::contentTypes['fetchPromotedProducts'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalAccountCreativesByAccountIdWithHttpInfo($account_id, string $contentType = self::contentTypes['getApi202110ExternalAccountCreativesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Creative202110ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalAccountCreativesByAccountIdRequest($account_id, string $contentType = self::contentTypes['getApi202110ExternalAccountCreativesByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/creatives';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAddToBasketByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingAudiencesByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/audiences';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response|\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalPreferredLineItemTargetingStoresByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingStoresByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalPreferredLineItemTargetingStoresByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApi202110ExternalPreferredLineItemTargetingStoresByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/stores';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202110ExternalRetailerPagesByRetailerIdWithHttpInfo($retailer_id, string $contentType = self::contentTypes['getApi202110ExternalRetailerPagesByRetailerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ExternalRetailerPages202110',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202110ExternalRetailerPagesByRetailerIdRequest($retailer_id, string $contentType = self::contentTypes['getApi202110ExternalRetailerPagesByRetailerId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/retailers/{retailerId}/pages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Category202204
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Category202204, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202204ExternalCategorieByCategoryIdWithHttpInfo($category_id, string $contentType = self::contentTypes['getApi202204ExternalCategorieByCategoryId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Category202204' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Category202204' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Category202204', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Category202204';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Category202204',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202204ExternalCategorieByCategoryIdRequest($category_id, string $contentType = self::contentTypes['getApi202204ExternalCategorieByCategoryId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/categories/{categoryId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202204ExternalCategoriesWithHttpInfo($page_index = 0, $page_size = 100, $retailer_id = null, $text_substring = null, string $contentType = self::contentTypes['getApi202204ExternalCategories'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Category202204ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202204ExternalCategoriesRequest($page_index = 0, $page_size = 100, $retailer_id = null, $text_substring = null, string $contentType = self::contentTypes['getApi202204ExternalCategories'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\TemplateResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\TemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdWithHttpInfo($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\TemplateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\TemplateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\TemplateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\TemplateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\TemplateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerByRetailerIdTemplatestemplateIdRequest($retailer_id, $template_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerByRetailerIdTemplatestemplateId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/retailers/{retailer-id}/templates/{template-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\TemplateListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\TemplateListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202207ExternalRetailerTemplatesByRetailerIdWithHttpInfo($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\TemplateListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\TemplateListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\TemplateListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\TemplateListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\TemplateListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202207ExternalRetailerTemplatesByRetailerIdRequest($retailer_id, string $contentType = self::contentTypes['getApi202207ExternalRetailerTemplatesByRetailerId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/retailers/{retailer-id}/templates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202301ExternalAccountCampaignsByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApi202301ExternalAccountCampaignsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfCampaignV202301',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202301ExternalAccountCampaignsByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApi202301ExternalAccountCampaignsByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApi202301ExternalCampaignByCampaignIdWithHttpInfo($campaign_id, string $contentType = self::contentTypes['getApi202301ExternalCampaignByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCampaignV202301',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApi202301ExternalCampaignByCampaignIdRequest($campaign_id, string $contentType = self::contentTypes['getApi202301ExternalCampaignByCampaignId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/campaigns/{campaignId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountBrandsByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountBrandsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfBrand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountBrandsByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountBrandsByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/brands';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountRetailersByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountRetailersByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiPageResponseOfRetailer',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountRetailersByAccountIdRequest($account_id, $limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccountRetailersByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/retailers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getApiV1ExternalCatalogOutputByCatalogIdRequest($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogOutputByCatalogId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/catalogs/{catalogId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalCatalogStatusByCatalogIdWithHttpInfo($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogStatusByCatalogId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalCatalogStatusByCatalogIdRequest($catalog_id, string $contentType = self::contentTypes['getApiV1ExternalCatalogStatusByCatalogId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/catalogs/{catalogId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Creative2Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Creative2Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalAccountByAccountIdCreativescreativeIdWithHttpInfo($account_id, $creative_id, string $contentType = self::contentTypes['getApiV2ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Creative2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Creative2Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Creative2Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Creative2Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Creative2Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalAccountByAccountIdCreativescreativeIdRequest($account_id, $creative_id, string $contentType = self::contentTypes['getApiV2ExternalAccountByAccountIdCreativescreativeId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/creatives/{creative-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalAccountLineItemsByAccountIdWithHttpInfo($account_id, $limit_to_campaign_id = null, $limit_to_id = null, $limit_to_type = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalAccountLineItemsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemPagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalAccountLineItemsByAccountIdRequest($account_id, $limit_to_campaign_id = null, $limit_to_id = null, $limit_to_type = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalAccountLineItemsByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse|\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse|\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalAuctionLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalAuctionLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalAuctionLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalAuctionLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/auction-line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse|\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse|\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalCampaignAuctionLineItemsByCampaignIdWithHttpInfo($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignAuctionLineItemsByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\AuctionLineItemPagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalCampaignAuctionLineItemsByCampaignIdRequest($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignAuctionLineItemsByCampaignId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/campaigns/{campaign-id}/auction-line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse|\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse|\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalCampaignPreferredLineItemsByCampaignIdWithHttpInfo($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignPreferredLineItemsByCampaignId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalCampaignPreferredLineItemsByCampaignIdRequest($campaign_id, $limit_to_id = null, $page_index = null, $page_size = null, string $contentType = self::contentTypes['getApiV2ExternalCampaignPreferredLineItemsByCampaignId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/campaigns/{campaign-id}/preferred-line-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalLineItemBidMultipliersByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalLineItemBidMultipliersByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/bid-multipliers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\CommonLineItemResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response|\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response|\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV2ExternalPreferredLineItemByLineItemIdWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalPreferredLineItemByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\PreferredLineItemV2Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV2ExternalPreferredLineItemByLineItemIdRequest($line_item_id, string $contentType = self::contentTypes['getApiV2ExternalPreferredLineItemByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignBudgetOverridesWithHttpInfo($campaign_id, string $contentType = self::contentTypes['getCampaignBudgetOverrides'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfCampaignBudgetOverrides',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCampaignBudgetOverridesRequest($campaign_id, string $contentType = self::contentTypes['getCampaignBudgetOverrides'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/campaigns/{campaignId}/campaign-budget-overrides';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $retailer_id Retailer Id. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputCpcMinBidsRequest $value_resource_input_cpc_min_bids_request Cpc minimum bid amount request object. (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCpcMinBidsBySkuIdsV1WithHttpInfo($retailer_id, $value_resource_input_cpc_min_bids_request = null, string $contentType = self::contentTypes['getCpcMinBidsBySkuIdsV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeCpcMinBidsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCpcMinBidsBySkuIdsV1Request($retailer_id, $value_resource_input_cpc_min_bids_request = null, string $contentType = self::contentTypes['getCpcMinBidsBySkuIdsV1'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/retailers/{retailerId}/cpc-min-bids';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLineItemBudgetOverridesWithHttpInfo($line_item_id, string $contentType = self::contentTypes['getLineItemBudgetOverrides'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfLineItemBudgetOverrides',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getLineItemBudgetOverridesRequest($line_item_id, string $contentType = self::contentTypes['getLineItemBudgetOverrides'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{lineItemId}/line-item-budget-overrides';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getRecommendedKeywordsWithHttpInfo($external_line_item_id, string $contentType = self::contentTypes['getRecommendedKeywords'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfRecommendedKeywordsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfRecommendedKeywordsResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfRecommendedKeywordsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfRecommendedKeywordsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeOfRecommendedKeywordsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getRecommendedKeywordsRequest($external_line_item_id, string $contentType = self::contentTypes['getRecommendedKeywords'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{externalLineItemId}/keywords/recommended';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function inReviewReportV1WithHttpInfo($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['inReviewReportV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function inReviewReportV1Request($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['inReviewReportV1'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/keywords/in-review-report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function pausePromotedProductsRequest($line_item_id, $promoted_product_resource_collection_input = null, string $contentType = self::contentTypes['pausePromotedProducts'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/products/pause';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApi202110ExternalBalanceCampaignsAppendByBalanceIdWithHttpInfo($balance_id, $balance_campaign202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalBalanceCampaignsAppendByBalanceId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\BalanceCampaign202110PagedListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function postApi202110ExternalBalanceCampaignsAppendByBalanceIdRequest($balance_id, $balance_campaign202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalBalanceCampaignsAppendByBalanceId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/balances/{balance-id}/campaigns/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalBalanceCampaignsDeleteByBalanceIdRequest($balance_id, $balance_campaign202110_list_request = null, string $contentType = self::contentTypes['postApi202110ExternalBalanceCampaignsDeleteByBalanceId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/balances/{balance-id}/campaigns/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAddToBasketAppendByLineItemIdRequest($line_item_id, $add_to_basket_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAddToBasketAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAddToBasketDeleteByLineItemIdRequest($line_item_id, $add_to_basket_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAddToBasketDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/add-to-basket/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAudiencesAppendByLineItemIdRequest($line_item_id, $audience_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAudiencesAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/audiences/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingAudiencesDeleteByLineItemIdRequest($line_item_id, $audience_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingAudiencesDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/audiences/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingStoresAppendByLineItemIdRequest($line_item_id, $store_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingStoresAppendByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/stores/append';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function postApi202110ExternalPreferredLineItemTargetingStoresDeleteByLineItemIdRequest($line_item_id, $store_ids_update_model202110_request = null, string $contentType = self::contentTypes['postApi202110ExternalPreferredLineItemTargetingStoresDeleteByLineItemId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/stores/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2025_07\Model\CreativeCreateModel202207 $creative_create_model202207 The creative to create (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Creative202210Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Creative202210Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApi202210ExternalAccountCreativesByAccountIdWithHttpInfo($account_id, $creative_create_model202207 = null, string $contentType = self::contentTypes['postApi202210ExternalAccountCreativesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Creative202210Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Creative202210Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Creative202210Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Creative202210Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Creative202210Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $account_id The account to request the campaign for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\PostCampaignV202301 $post_campaign_v202301 Creatable campaign attributes (optional)
     ...
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfBrandCatalogRequestV2 $value_resource_input_of_brand_catalog_request_v2 value_resource_input_of_brand_catalog_request_v2 (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2|\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2|\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2
     */
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfBrandCatalogRequestV2 $value_resource_input_of_brand_catalog_request_v2 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiExternalV2AccountBrandCatalogExportByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2|\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2|\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiExternalV2AccountBrandCatalogExportByAccountIdWithHttpInfo($account_id, $value_resource_input_of_brand_catalog_request_v2 = null, string $contentType = self::contentTypes['postApiExternalV2AccountBrandCatalogExportByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\EntityResourceOutcomeOfCatalogStatusV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function postApiExternalV2AccountBrandCatalogExportByAccountIdRequest($account_id, $value_resource_input_of_brand_catalog_request_v2 = null, string $contentType = self::contentTypes['postApiExternalV2AccountBrandCatalogExportByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/brand-catalog-export';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfSellerCatalogRequestV2 $value_resource_input_of_seller_catalog_request_v2 value_resource_input_of_seller_catalog_request_v2 (optional)
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfSellerCatalogRequestV2 $value_resource_input_of_seller_catalog_request_v2 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiExternalV2AccountSellerCatalogExportByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postApiExternalV2AccountSellerCatalogExportByAccountIdRequest($account_id, $value_resource_input_of_seller_catalog_request_v2 = null, string $contentType = self::contentTypes['postApiExternalV2AccountSellerCatalogExportByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/seller-catalog-export';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\JsonApiRequestOfCatalogRequest $json_api_request_of_catalog_request json_api_request_of_catalog_request (optional)
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\JsonApiRequestOfCatalogRequest $json_api_request_of_catalog_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountCatalogsByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postApiV1ExternalAccountCatalogsByAccountIdRequest($account_id, $json_api_request_of_catalog_request = null, string $contentType = self::contentTypes['postApiV1ExternalAccountCatalogsByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/catalogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\JsonApiRequestOfSellerCatalogRequest $json_api_request_of_seller_catalog_request json_api_request_of_seller_catalog_request (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus|\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus
     */
     ...
     *
     * @param  string $account_id The account to request the catalog for. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\JsonApiRequestOfSellerCatalogRequest $json_api_request_of_seller_catalog_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApiV1ExternalAccountCatalogsSellersByAccountId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus|\criteo\api\retailmedia\v2025_07\Model\JsonApiSingleResponseOfCatalogStatus, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postApiV1ExternalAccountCatalogsSellersByAccountIdRequest($account_id, $json_api_request_of_seller_catalog_request = null, string $contentType = self::contentTypes['postApiV1ExternalAccountCatalogsSellersByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{accountId}/catalogs/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV2ExternalAccountCreativesSearchByAccountIdWithHttpInfo($account_id, $creative_ids = null, string $contentType = self::contentTypes['postApiV2ExternalAccountCreativesSearchByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\Creative2ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function postApiV2ExternalAccountCreativesSearchByAccountIdRequest($account_id, $creative_ids = null, string $contentType = self::contentTypes['postApiV2ExternalAccountCreativesSearchByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/accounts/{account-id}/creatives/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $campaign_id The given campaign id (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemCreateModelRequest $auction_line_item_create_model_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\AddToBasketTarget202110Request $add_to_basket_target202110_request The add to basket target to set the scope for (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\AudienceTarget202110Request $audience_target202110_request The audience target to set the scope for (optional)
     ...
     *
     * @param  string $line_item_id The line item to interact with (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\StoreTarget202110Request $store_target202110_request The store target to set the scope for (optional)
     ...
     * @param  \criteo\api\retailmedia\v2025_07\Model\CreativeUpdateModel202207 $creative_update_model202207 The creative to create (optional)
     ...
     * @param  \criteo\api\retailmedia\v2025_07\Model\PutCampaignV202301 $put_campaign_v202301 Editable campaign attributes (optional)
     ...
     *
     * @param  string $line_item_id The given line item id (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\AuctionLineItemUpdateModelRequest $auction_line_item_update_model_request The line item settings to create a line item with (optional)
     ...
     *
     * @param  string $line_item_id External LineItemId for bid multiplier retrieval (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Request $line_item_bid_multipliers_v2_request New Bid Multipliers to be set (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function putApiV2ExternalLineItemBidMultipliersByLineItemIdWithHttpInfo($line_item_id, $line_item_bid_multipliers_v2_request = null, string $contentType = self::contentTypes['putApiV2ExternalLineItemBidMultipliersByLineItemId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\LineItemBidMultipliersV2Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function setKeywordBidsRequest($id, $set_bids_model_request = null, string $contentType = self::contentTypes['setKeywordBids'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{id}/keywords/set-bid';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function unpausePromotedProductsRequest($line_item_id, $promoted_product_resource_collection_input = null, string $contentType = self::contentTypes['unpausePromotedProducts'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/products/unpause';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $campaign_id Campaign id. (required)
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfCampaignBudgetOverrides $value_resource_input_of_campaign_budget_overrides New campaign budget overrides settings value resource input. (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateKeywordReviewsV1WithHttpInfo($line_item_id, $value_resource_input_retail_media_keywords_review = null, string $contentType = self::contentTypes['updateKeywordReviewsV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_07\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateKeywordReviewsV1Request($line_item_id, $value_resource_input_retail_media_keywords_review = null, string $contentType = self::contentTypes['updateKeywordReviewsV1'][0])
    {
        ...
        $resourcePath = '/2025-07/retail-media/line-items/{line-item-id}/keywords/review';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2025_07\Model\ValueResourceInputOfLineItemBudgetOverrides $value_resource_input_of_line_item_budget_overrides New line item budget overrides settings value resource input. (optional)
