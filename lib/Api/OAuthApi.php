...
/**
     ...
     * @return \criteo\api\retailmedia\v2023_01\Model\AccessTokenModel|\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel|\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel
     */
     ...
     * @throws \criteo\api\retailmedia\v2023_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2023_01\Model\AccessTokenModel|\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel|\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenWithHttpInfo($grant_type, $client_id, $client_secret, $redirect_uri = null, $code = null, $refresh_token = null, string $contentType = self::contentTypes['getToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2023_01\Model\AccessTokenModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\AccessTokenModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2023_01\Model\AccessTokenModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2023_01\Model\OAuthErrorModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\criteo\api\retailmedia\v2023_01\Model\AccessTokenModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2023_01\Model\AccessTokenModel',
