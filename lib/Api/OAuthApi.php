...
class OAuthApi
{
     ...
     * @return \criteo\api\retailmedia\v2020_10\Model\JwtModel|\criteo\api\retailmedia\v2020_10\Model\OAuth2Error
     */
     ...
     * @throws \criteo\api\retailmedia\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2020_10\Model\JwtModel|\criteo\api\retailmedia\v2020_10\Model\OAuth2Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTokenWithHttpInfo($client_id = null, $client_secret = null, $grant_type = 'client_credentials')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2020_10\Model\JwtModel' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2020_10\Model\JwtModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\criteo\api\retailmedia\v2020_10\Model\OAuth2Error' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2020_10\Model\OAuth2Error', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2020_10\Model\JwtModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2020_10\Model\JwtModel',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2020_10\Model\OAuth2Error',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
