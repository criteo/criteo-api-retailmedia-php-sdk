...
/**
     ...
     *
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfSellerSearch $value_resource_input_of_seller_search  (required)
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller value_resource_collection_input_of_retail_media_seller (required)
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSellers'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
