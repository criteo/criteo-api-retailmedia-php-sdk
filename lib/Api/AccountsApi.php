...
/**
     ...
     * @param  \criteo\api\retailmedia\v2024_07\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands brands to associate to account (optional)
     ...
     * @return \criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands, HTTP status code, HTTP response headers (array of strings)
     */
    public function addBrandsWithHttpInfo($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['addBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_07\Model\ValueResourceOfRetailMediaBrands',
     ...
     * @param  \criteo\api\retailmedia\v2024_07\Model\ValueResourceInputOfRetailMediaBrandAccountCreation $value_resource_input_of_retail_media_brand_account_creation Initial creation and configuration options for the new account (optional)
     ...
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount
     */
     ...
     * @throws \criteo\api\retailmedia\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPrivateMarketDemandBrandAccountWithHttpInfo($account_id, $value_resource_input_of_retail_media_brand_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandBrandAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2024_07\Model\ResourceOutcomeOfRetailMediaAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $account_id Account Id for the parent private market account (required)
     * @param  \criteo\api\retailmedia\v2024_07\Model\ValueResourceInputOfRetailMediaSellerAccountCreation $value_resource_input_of_retail_media_seller_account_creation Initial creation and configuration options for the new account (optional)
     ...
     *
     * @param  string $account_id The account id to update (required)
     * @param  \criteo\api\retailmedia\v2024_07\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands Brands to remove from account (optional)
     ...
     *
     * @param  string $account_id the account id to update (required)
     * @param  \criteo\api\retailmedia\v2024_07\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller sellers to associate (optional)
