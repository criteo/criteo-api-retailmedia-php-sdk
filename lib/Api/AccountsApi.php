...
/**
     ...
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands value_resource_input_of_retail_media_brands (optional)
     ...
     * @return \criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands
     */
     ...
     *
     * @param  string $account_id the account id to update (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addBrands'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands, HTTP status code, HTTP response headers (array of strings)
     */
    public function addBrandsWithHttpInfo($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['addBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\ValueResourceOutcomeOfRetailMediaBrands',
    ...
    public function addBrandsRequest($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['addBrands'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/brands/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaBrandAccountCreation $value_resource_input_of_retail_media_brand_account_creation value_resource_input_of_retail_media_brand_account_creation (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount
     */
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaBrandAccountCreation $value_resource_input_of_retail_media_brand_account_creation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateMarketDemandBrandAccount'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPrivateMarketDemandBrandAccountWithHttpInfo($account_id, $value_resource_input_of_retail_media_brand_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandBrandAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\EntityResourceOutcomeOfRetailMediaAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createPrivateMarketDemandBrandAccountRequest($account_id, $value_resource_input_of_retail_media_brand_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandBrandAccount'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/create-brand-account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaSellerAccountCreation $value_resource_input_of_retail_media_seller_account_creation value_resource_input_of_retail_media_seller_account_creation (optional)
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfRetailMediaSellerAccountCreation $value_resource_input_of_retail_media_seller_account_creation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateMarketDemandSellerAccount'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function createPrivateMarketDemandSellerAccountRequest($account_id, $value_resource_input_of_retail_media_seller_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandSellerAccount'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/create-seller-account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiExternalV1AccountPrivateMarketChildAccountsByAccountIdWithHttpInfo($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getApiExternalV1AccountPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiExternalV1AccountPrivateMarketChildAccountsByAccountIdRequest($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getApiExternalV1AccountPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/private-market-child-accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApiV1ExternalAccountsWithHttpInfo($limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccounts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\JsonApiPageResponseOfAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getApiV1ExternalAccountsRequest($limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getApiV1ExternalAccounts'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2025_04\Model\GrantConsentInput $grant_consent_input grant_consent_input (optional)
     ...
     *
     * @param  string $account_id The demand account ID on which to grant consent (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\GrantConsentInput $grant_consent_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['grantConsent'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function grantConsentRequest($account_id, $grant_consent_input = null, string $contentType = self::contentTypes['grantConsent'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/accounts/{accountId}/grant-consent';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function removeBrandsRequest($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['removeBrands'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/brands/remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceInputOfSellerSearch $value_resource_input_of_seller_search  (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult|\criteo\api\retailmedia\v2025_04\Model\Outcome|\criteo\api\retailmedia\v2025_04\Model\Outcome
     */
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult|\criteo\api\retailmedia\v2025_04\Model\Outcome|\criteo\api\retailmedia\v2025_04\Model\Outcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchSellersWithHttpInfo($value_resource_input_of_seller_search = null, string $contentType = self::contentTypes['searchSellers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\criteo\api\retailmedia\v2025_04\Model\Outcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\Outcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\Outcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfSellerSearchResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\Outcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchSellersRequest($value_resource_input_of_seller_search = null, string $contentType = self::contentTypes['searchSellers'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/accounts/sellers/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller value_resource_collection_input_of_retail_media_seller (optional)
     ...
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller
     */
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSellers'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSellersWithHttpInfo($account_id, $value_resource_collection_input_of_retail_media_seller = null, string $contentType = self::contentTypes['updateSellers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2025_04\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateSellersRequest($account_id, $value_resource_collection_input_of_retail_media_seller = null, string $contentType = self::contentTypes['updateSellers'][0])
    {
        ...
        $resourcePath = '/2025-04/retail-media/account-management/accounts/{accountId}/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
