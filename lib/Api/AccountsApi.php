...
/**
     ...
     * @param  \criteo\api\retailmedia\v2026_01\Model\ValueResourceInputAccountFeesSearchRequest $value_resource_input_account_fees_search_request value_resource_input_account_fees_search_request (optional)
     ...
     * @param  int $limit used for paging, number of results returned per request, Maximum of 500 (optional, default to 50)
     * @param  int $offset used for paging, number of records to skip (optional, default to 0)
     * @param  \criteo\api\retailmedia\v2026_01\Model\ValueResourceInputAccountFeesSearchRequest $value_resource_input_account_fees_search_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountFeesSearch'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_01\Model\ValueResourceInputAccountFeesUpdateRequest $value_resource_input_account_fees_update_request value_resource_input_account_fees_update_request (optional)
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_01\Model\ValueResourceInputAccountFeesUpdateRequest $value_resource_input_account_fees_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateAccountFees'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
