...
class AudienceApi
{
     ...
     * @param  \criteo\api\retailmedia\preview\Model\CreateAudienceRequest $create_audience_request create_audience_request (required)
     *
     ...
     *
     * @param  string $account_id ID of the account to which this audience belongs. (required)
     * @param  \criteo\api\retailmedia\preview\Model\CreateAudienceRequest $create_audience_request (required)
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
