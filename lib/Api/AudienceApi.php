...
/**
     ...
     * @param  \criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceRequest $create_retail_media_audience_request create_retail_media_audience_request (required)
     ...
     * @return \criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse
     */
     ...
     *
     * @param  string $account_id ID of the account to which this audience belongs. (required)
     * @param  \criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceRequest $create_retail_media_audience_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAudience'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2022_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAudienceWithHttpInfo($account_id, $create_retail_media_audience_request, string $contentType = self::contentTypes['createAudience'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_10\Model\CreateRetailMediaAudienceResponse',
    ...
    public function createAudienceRequest($account_id, $create_retail_media_audience_request, string $contentType = self::contentTypes['createAudience'][0])
    {
        ...
        $resourcePath = '/2022-10/retail-media/accounts/{accountId}/audiences';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2022_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudiencesByAccountIdWithHttpInfo($account_id, $limit_to_id = null, $page_size = null, $page_index = null, string $contentType = self::contentTypes['getAudiencesByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2022_10\Model\GetPageOfAudiencesByAccountIdResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
