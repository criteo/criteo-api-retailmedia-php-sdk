...
/**
     ...
     * @param  \criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceRequest $create_retail_media_audience_request create_retail_media_audience_request (required)
     ...
     * @return \criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse
     */
     ...
     *
     * @param  string $account_id ID of the account to which this audience belongs. (required)
     * @param  \criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceRequest $create_retail_media_audience_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAudience'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAudienceWithHttpInfo($account_id, $create_retail_media_audience_request, string $contentType = self::contentTypes['createAudience'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\preview\Model\CreateRetailMediaAudienceResponse',
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\preview\Model\RetailMediaAudienceV2Response' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\RetailMediaAudienceV2Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
