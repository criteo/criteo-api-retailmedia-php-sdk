...
class GatewayApi
{
     ...
     * @return \criteo\api\retailmedia\v2022_01\Model\ApplicationSummaryModelResponse
     */
     ...
     * @throws \criteo\api\retailmedia\v2022_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2022_01\Model\ApplicationSummaryModelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrentApplicationWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2022_01\Model\ApplicationSummaryModelResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2022_01\Model\ApplicationSummaryModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2022_01\Model\ApplicationSummaryModelResponse';
