...
/**
 * DisplayCampaignSearchModel Class Doc Comment
 *
 * @category Class
 * @description Model for searching display campaigns with various filter criteria.
 * @package  criteo\api\retailmedia\preview
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DisplayCampaignSearchModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisplayCampaignSearchModel';
    ...
    */
     ...
     * Sets buy_type
     *
     * @param string|null $buy_type The Buy type of Campaigns to filter by.
     *
     * @return self
     */
     ...
     * Sets campaign_ids
     *
     * @param string[]|null $campaign_ids The list of Campaign IDs to filter by.
     *
     * @return self
     */
