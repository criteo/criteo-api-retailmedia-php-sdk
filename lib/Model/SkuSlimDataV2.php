...
/**
 * SkuSlimDataV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class SkuSlimDataV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SkuSlimDataV2';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'retailer_category' => '\criteo\api\retailmedia\preview\Model\RetailerCategory',
        'global_category_id' => 'string',
        'global_brand' => '\criteo\api\retailmedia\preview\Model\GlobalBrand',
        'retailer_brand' => '\criteo\api\retailmedia\preview\Model\RetailerBrand',
        'price' => 'float',
        'is_in_stock' => 'bool',
        'gtin' => 'string',
        'mpn' => 'string',
    ...
    protected static array $openAPINullables = [
        'name' => false,
		'description' => false,
		'retailer_category' => false,
		'global_category_id' => false,
		'global_brand' => false,
		'retailer_brand' => false,
		'price' => false,
		'is_in_stock' => false,
		'gtin' => false,
		'mpn' => false,
    ...
    protected static $setters = [
        ...
        'retailer_category' => 'setRetailerCategory',
        'global_category_id' => 'setGlobalCategoryId',
        'global_brand' => 'setGlobalBrand',
        'retailer_brand' => 'setRetailerBrand',
        'price' => 'setPrice',
    ...
    protected static $getters = [
        ...
        'retailer_category' => 'getRetailerCategory',
        'global_category_id' => 'getGlobalCategoryId',
        'global_brand' => 'getGlobalBrand',
        'retailer_brand' => 'getRetailerBrand',
        'price' => 'getPrice',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('retailer_category', $data ?? [], null);
        $this->setIfExists('global_category_id', $data ?? [], null);
        $this->setIfExists('global_brand', $data ?? [], null);
        $this->setIfExists('retailer_brand', $data ?? [], null);
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A short description of the product.
     *
     * @return self
     */
    ...
    /**
     * Gets retailer_category
     *
     * @return \criteo\api\retailmedia\preview\Model\RetailerCategory|null
     */
    public function getRetailerCategory()
    {
        return $this->container['retailer_category'];
    }

    /**
     * Sets retailer_category
     *
     * @param \criteo\api\retailmedia\preview\Model\RetailerCategory|null $retailer_category retailer_category
     *
     * @return self
     */
    public function setRetailerCategory($retailer_category)
    {
        if (is_null($retailer_category)) {
            throw new \InvalidArgumentException('non-nullable retailer_category cannot be null');
        }
        $this->container['retailer_category'] = $retailer_category;
     ...
     * Gets global_brand
     *
     * @return \criteo\api\retailmedia\preview\Model\GlobalBrand|null
     */
    public function getGlobalBrand()
    {
        return $this->container['global_brand'];
    }

    /**
     * Sets global_brand
     *
     * @param \criteo\api\retailmedia\preview\Model\GlobalBrand|null $global_brand global_brand
     *
     * @return self
     */
    public function setGlobalBrand($global_brand)
    {
        if (is_null($global_brand)) {
            throw new \InvalidArgumentException('non-nullable global_brand cannot be null');
        }
        $this->container['global_brand'] = $global_brand;
     ...
     * Gets retailer_brand
     *
     * @return \criteo\api\retailmedia\preview\Model\RetailerBrand|null
     */
    public function getRetailerBrand()
    {
        return $this->container['retailer_brand'];
    }

    /**
     * Sets retailer_brand
     *
     * @param \criteo\api\retailmedia\preview\Model\RetailerBrand|null $retailer_brand retailer_brand
     *
     * @return self
     */
    public function setRetailerBrand($retailer_brand)
    {
        if (is_null($retailer_brand)) {
            throw new \InvalidArgumentException('non-nullable retailer_brand cannot be null');
        }
        $this->container['retailer_brand'] = $retailer_brand;
