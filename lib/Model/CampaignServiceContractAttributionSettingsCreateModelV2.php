...
/**
 * CampaignServiceContractAttributionSettingsCreateModelV2 Class Doc Comment
 *
 * @category Class
 * @description Wrapper for attribution settings. Each setting may be omitted, in which case it is populated with the default for the campaign type.
 * @package  criteo\api\retailmedia\experimental
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CampaignServiceContractAttributionSettingsCreateModelV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignServiceContractAttributionSettingsCreateModelV2';
