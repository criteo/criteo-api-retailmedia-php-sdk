...
/**
 * SkuSearchRequestSlimPreview Class Doc Comment
 *
 * @category Class
 ...
 */
class SkuSearchRequestSlimPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SkuSearchRequestSlimPreview';
    ...
    */
     ...
     * @return string[]
     */
    public function getLimitResultsToSkusWithBrandIds()
    {
        return $this->container['limit_results_to_skus_with_brand_ids'];
    }

    /**
     * Sets limit_results_to_skus_with_brand_ids
     *
     * @param string[] $limit_results_to_skus_with_brand_ids A list of brand Id's to limit the search results to
     *
     * @return self
     */
    public function setLimitResultsToSkusWithBrandIds($limit_results_to_skus_with_brand_ids)
    {
        if (is_null($limit_results_to_skus_with_brand_ids)) {
