...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets count
     *
     * @param int|null $count Total number of line items matching the search.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum size of the paginated result set.
     *
     * @return self
     */
     ...
     * Sets offset
     *
     * @param int|null $offset Zero based offset for the paginated result set.
     *
     * @return self
     */
