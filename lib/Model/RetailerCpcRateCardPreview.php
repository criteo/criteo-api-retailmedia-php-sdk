...
class RetailerCpcRateCardPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('minimum_bid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets minimum_bid
     *
     * @param float $minimum_bid Minimum Bid
     *
     * @return self
     */
    public function setMinimumBid($minimum_bid)
    {
        if (is_null($minimum_bid)) {
            throw new \InvalidArgumentException('non-nullable minimum_bid cannot be null');
        }
