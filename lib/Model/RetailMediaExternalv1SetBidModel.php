...
/**
 * RetailMediaExternalv1SetBidModel Class Doc Comment
 *
 * @category Class
 ...
 */
class RetailMediaExternalv1SetBidModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetailMediaExternalv1SetBidModel';
    ...
    public function setPhrase($phrase)
    {
        if (!is_null($phrase) && (mb_strlen($phrase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phrase when calling RetailMediaExternalv1SetBidModel., must be smaller than or equal to 255.');
        }
        if (!is_null($phrase) && (mb_strlen($phrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phrase when calling RetailMediaExternalv1SetBidModel., must be bigger than or equal to 0.');
        }
