 ...
 *
 * @category Class
 * @description New flight dates for a SponsoredProducts campaign. Omit the whole node to leave the schedule  unchanged; when present, both dates are required together.
 * @package  criteo\api\retailmedia\experimental
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ScheduleDetailsUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date New campaign end date. Pass exactly {9999-12-30T00:00:00Z} to make the campaign run  indefinitely; any other value is a real end date.
     *
     * @return self
     */
