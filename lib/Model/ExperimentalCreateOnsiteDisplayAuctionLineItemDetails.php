...
/**
 * ExperimentalCreateOnsiteDisplayAuctionLineItemDetails Class Doc Comment
 *
 * @category Class
 * @description Auction settings to create an onsite display line item with.
 * @package  criteo\api\retailmedia\experimental
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExperimentalCreateOnsiteDisplayAuctionLineItemDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentalCreateOnsiteDisplayAuctionLineItemDetails';
