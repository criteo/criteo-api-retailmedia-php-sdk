...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'sections' => '\criteo\api\retailmedia\v2022_07\Model\Section[]'
    ];
    ...
    const CREATIVE_FORMAT_UNKNOWN = 'Unknown';
    const CREATIVE_FORMAT_FLAG_SHIP = 'FlagShip';
    const CREATIVE_FORMAT_SHOWCASE = 'Showcase';
    const CREATIVE_FORMAT_SPONSORED_PRODUCTS = 'SponsoredProducts';
    const CREATIVE_FORMAT_BUTTERFLY = 'Butterfly';
    const CREATIVE_FORMAT_BUNDLE_BOOST = 'BundleBoost';
    const CREATIVE_FORMAT_IAB = 'IAB';
    const CREATIVE_FORMAT_CUSTOM = 'CUSTOM';
    const CREATIVE_FORMAT_DISPLAY_PANEL = 'DisplayPanel';
    const CREATIVE_FORMAT_DIGITAL_SHELF_TALKER = 'DigitalShelfTalker';
    ...
    {
        $this->container['creative_format'] = $data['creative_format'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['retailer_id'] = $data['retailer_id'] ?? null;
        $this->container['sku_collection_min'] = $data['sku_collection_min'] ?? null;
        $this->container['sku_collection_max'] = $data['sku_collection_max'] ?? null;
        $this->container['sku_per_collection_min'] = $data['sku_per_collection_min'] ?? null;
        $this->container['sku_per_collection_max'] = $data['sku_per_collection_max'] ?? null;
        $this->container['displayable_skus_max'] = $data['displayable_skus_max'] ?? null;
        $this->container['all_collections_mandatory'] = $data['all_collections_mandatory'] ?? null;
     ...
     * Gets sections
     *
     * @return \criteo\api\retailmedia\v2022_07\Model\Section[]
     */
     ...
     * Sets sections
     *
     * @param \criteo\api\retailmedia\v2022_07\Model\Section[] $sections The sections holding various template variables
     *
     * @return self
     */
