...
class RecommendedKeywordsRequestV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sku_ids
     *
     * @param string[] $sku_ids Sku Id list that the recommended keywords generated on.
     *
     * @return self
     */
    public function setSkuIds($sku_ids)
    {
        ...
        if ((count($sku_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku_ids when calling RecommendedKeywordsRequestV1., number of items must be greater than or equal to 1.');
        }
