...
/**
 * ExternalPromotedProduct Class Doc Comment
 *
 * @category Class
 ...
 */
class ExternalPromotedProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalPromotedProduct';
    ...
    {
        $this->container['bid_override'] = $data['bid_override'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bid_override'] === null) {
            $invalidProperties[] = "'bid_override' can't be null";
        }
     ...
     * Sets bid_override
     *
     * @param float $bid_override bid_override
     *
     * @return self
     */
