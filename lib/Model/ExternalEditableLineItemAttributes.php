...
/**
 * ExternalEditableLineItemAttributes Class Doc Comment
 *
 * @category Class
 ...
 */
class ExternalEditableLineItemAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalEditableLineItemAttributes';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExternalEditableLineItemAttributes., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExternalEditableLineItemAttributes., must be bigger than or equal to 0.');
        }
     ...
     * Sets target_bid
     *
     * @param float $target_bid The greater value between RMP default of $0.3 or a retailer-specific value - varies by retailer
     *
     * @return self
     */
