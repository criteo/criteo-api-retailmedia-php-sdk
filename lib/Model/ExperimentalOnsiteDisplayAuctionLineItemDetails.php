...
/**
 * ExperimentalOnsiteDisplayAuctionLineItemDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ExperimentalOnsiteDisplayAuctionLineItemDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentalOnsiteDisplayAuctionLineItemDetails';
    ...
    */
     ...
     *
     * @param bool|null $is_dynamic_match Whether only products relevant to the page context serve, replacing manual SKU curation.
     *
     * @return self
     */
