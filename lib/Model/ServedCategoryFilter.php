...
/**
 * ServedCategoryFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class ServedCategoryFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServedCategoryFilter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['served_categories'] === null) {
            $invalidProperties[] = "'served_categories' can't be null";
        }
        if ((count($this->container['served_categories']) < 1)) {
            $invalidProperties[] = "invalid value for 'served_categories', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @param string[] $served_categories served_categories
     *
     * @return self
     */
    public function setServedCategories($served_categories)
    {
        if (is_null($served_categories)) {
            throw new \InvalidArgumentException('non-nullable served_categories cannot be null');
        }


        if ((count($served_categories) < 1)) {
            throw new \InvalidArgumentException('invalid length for $served_categories when calling ServedCategoryFilter., number of items must be greater than or equal to 1.');
        }
