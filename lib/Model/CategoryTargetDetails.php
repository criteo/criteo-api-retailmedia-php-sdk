...
/**
 * CategoryTargetDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CategoryTargetDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryTargetDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('include_children', $data ?? [], null);
    }
    ...
    */
    ...
    public function setIncludeChildren($include_children)
    {
        if (is_null($include_children)) {
            array_push($this->openAPINullablesSetToNull, 'include_children');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('include_children', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
