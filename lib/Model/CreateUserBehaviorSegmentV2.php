...
class CreateUserBehaviorSegmentV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const USER_ACTION_VIEW = 'view';
    const USER_ACTION_ADD_TO_CART = 'addToCart';
     ...
     * Sets min_price
     *
     * @param double|null $min_price The min price of targeted skus.
     *
     * @return self
     */
     ...
     * Sets max_price
     *
     * @param double|null $max_price The max price of targeted skus.
     *
     * @return self
     */
