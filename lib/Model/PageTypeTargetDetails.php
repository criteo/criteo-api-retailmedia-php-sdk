...
/**
 * PageTypeTargetDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PageTypeTargetDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageTypeTargetDetails';
    ...
    */
     ...
     * Sets page_type
     *
     * @param string|null $page_type Contract representation of pagetype Ids supplied by Inventory API.  This enum re-exposes those persisted byte IDs as typed values for target-service clients.
     *
     * @return self
     */
