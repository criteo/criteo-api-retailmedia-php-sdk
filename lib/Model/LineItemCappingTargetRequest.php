...
/**
 * LineItemCappingTargetRequest Class Doc Comment
 *
 * @category Class
 * @description Represents the frequency capping target for a line item.
 * @package  criteo\api\retailmedia\preview
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LineItemCappingTargetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineItemCappingTargetRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['capping_count'] === null) {
            $invalidProperties[] = "'capping_count' can't be null";
        }
     ...
     * Sets capping_count
     *
     * @param int $capping_count The maximum number of times the line item can be shown within the specified duration.
     *
     * @return self
     */
    public function setCappingCount($capping_count)
    {
        if (is_null($capping_count)) {
            throw new \InvalidArgumentException('non-nullable capping_count cannot be null');
        }
     ...
     *
     * @param string $capping_duration_type The duration type for the frequency capping (e.g., per session or per day).
     *
     * @return self
     */
