...
/**
 * ExternalColorVariableValue Class Doc Comment
 *
 * @category Class
 ...
 */
class ExternalColorVariableValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalColorVariableValue';
    ...
    */
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (!preg_match("/^#(([0-9a-fA-F]{2}){3}|([0-9a-fA-F]){3})$/", $color))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling ExternalColorVariableValue., must conform to the pattern /^#(([0-9a-fA-F]{2}){3}|([0-9a-fA-F]){3})$/.");
        }
