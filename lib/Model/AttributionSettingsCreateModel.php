...
/**
 * AttributionSettingsCreateModel Class Doc Comment
 *
 * @category Class
 * @description Wrapper for attribution settings. Each setting may be omitted, in which case it is  populated with the default for the campaign type: OnsiteDisplay defaults to a 14D click  window, a 14D view window and sameSkuCategory for both scopes; SponsoredProducts defaults  to a 30D click window, a 1D view window, sameSkuCategory click scope and sameSku view  scope.
 * @package  criteo\api\retailmedia\experimental
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AttributionSettingsCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttributionSettingsCreateModel';
    ...
    public const CLICK_ATTRIBUTION_WINDOW_ONE_WEEK = 'OneWeek';
    public const CLICK_ATTRIBUTION_WINDOW_TWO_WEEKS = 'TwoWeeks';
    public const CLICK_ATTRIBUTION_WINDOW_ONE_MONTH = 'OneMonth';
    ...
    public const VIEW_ATTRIBUTION_WINDOW_ONE_WEEK = 'OneWeek';
    public const VIEW_ATTRIBUTION_WINDOW_TWO_WEEKS = 'TwoWeeks';
    public const VIEW_ATTRIBUTION_WINDOW_ONE_MONTH = 'OneMonth';
    ...
    {
        return [
            self::CLICK_ATTRIBUTION_WINDOW_ONE_WEEK,
            self::CLICK_ATTRIBUTION_WINDOW_TWO_WEEKS,
            self::CLICK_ATTRIBUTION_WINDOW_ONE_MONTH,
        ];
    }
    ...
    public function getViewAttributionWindowAllowableValues()
    {
        return [
            ...
            self::VIEW_ATTRIBUTION_WINDOW_ONE_WEEK,
            self::VIEW_ATTRIBUTION_WINDOW_TWO_WEEKS,
            self::VIEW_ATTRIBUTION_WINDOW_ONE_MONTH,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $click_attribution_scope Post-click attribution scope setting.
     *
     * @return self
     */
     ...
     *
     * @param string|null $click_attribution_window Post-click attribution window setting.
     *
     * @return self
     */
     ...
     *
     * @param string|null $view_attribution_scope Post-view attribution scope setting. Must not be broader than the click attribution scope.
     *
     * @return self
     */
     ...
     *
     * @param string|null $view_attribution_window Post-view attribution window setting. Must not exceed the click attribution window.
     *
     * @return self
     */
