...
/**
 * AuctionBidRequest Class Doc Comment
 *
 * @category Class
 * @description Represents a bid for an auction display line item.
 * @package  criteo\api\retailmedia\preview
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AuctionBidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuctionBidRequest';
    ...
    */
     ...
     * Sets bid
     *
     * @param float $bid The bid amount for the auction.
     *
     * @return self
     */
     ...
     * Sets page_type
     *
     * @param string $page_type The page type for which the bid is configured.
     *
     * @return self
     */
