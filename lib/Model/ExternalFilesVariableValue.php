...
/**
 * ExternalFilesVariableValue Class Doc Comment
 *
 * @category Class
 ...
 */
class ExternalFilesVariableValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalFilesVariableValue';
    ...
    */
    ...
    public function setAssetIds($asset_ids)
    {
        ...
        if ((count($asset_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asset_ids when calling ExternalFilesVariableValue., number of items must be greater than or equal to 1.');
        }
