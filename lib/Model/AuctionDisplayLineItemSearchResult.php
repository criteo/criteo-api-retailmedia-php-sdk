...
/**
 * AuctionDisplayLineItemSearchResult Class Doc Comment
 *
 * @category Class
 * @description Represents the response model for a searched auction display line item, including proposal review status.
 * @package  criteo\api\retailmedia\preview
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AuctionDisplayLineItemSearchResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuctionDisplayLineItemSearchResult';
    ...
    protected static $openAPITypes = [
        ...
        'page_types' => 'string[]',
        'product_ids' => 'string[]',
        'proposal_status' => '\criteo\api\retailmedia\preview\Model\ProposalStatus',
        'retailer_id' => 'string',
        'start_date' => '\DateTime',
        'status' => 'string',
    ...
    protected static $setters = [
        ...
        'proposal_status' => 'setProposalStatus',
    ...
    protected static $getters = [
        ...
        'proposal_status' => 'getProposalStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('proposal_status', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets proposal_status
     *
     * @return \criteo\api\retailmedia\preview\Model\ProposalStatus|null
     */
    public function getProposalStatus()
    {
        return $this->container['proposal_status'];
    }

    /**
     * Sets proposal_status
     *
     * @param \criteo\api\retailmedia\preview\Model\ProposalStatus|null $proposal_status proposal_status
     *
     * @return self
     */
    public function setProposalStatus($proposal_status)
    {
        if (is_null($proposal_status)) {
            array_push($this->openAPINullablesSetToNull, 'proposal_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proposal_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['proposal_status'] = $proposal_status;
