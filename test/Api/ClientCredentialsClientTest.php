...
class ClientCredentialsClientTest extends TestCase
{
    ...
    public function testDoesNotInterceptRequestWhenNoAuthorizationHeader()
    {
        ...
        $response = (new criteo\api\retailmedia\v2022_10\Api\OAuthApi($mockClient))
